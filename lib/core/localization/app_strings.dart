...
class AppStrings {
  ...
  String get searchTooltip =>
      _t('Cari Kanji & Kotoba', 'Search Kanji & Kotoba');
  ...
  String get kanaSectionDakuten => _t('Tenten & Maru', 'Dakuten & Handakuten');
  ...
  String kanaSectionCount(int count) => _t('$count huruf', '$count characters');
  ...
  String homeLevelPointsLabel(int xpIntoLevel, int xpPerLevel) => _t(
    '$xpIntoLevel / $xpPerLevel poin',
    '$xpIntoLevel / $xpPerLevel points',
  );
  ...
  String get videoLearningTitle =>
      _t('Belajar dari Video', 'Learn from Videos');
  ...
  String get userIdTooltip => _t('Ketuk untuk salin ID', 'Tap to copy ID');
  String get googleAccountAlreadyLinked => _t(
  ...
  String streakDays(int streak) =>
      _t('$streak hari berturut-turut belajar!', '$streak days in a row!');
  String get keepYourStreak =>
      _t('Pertahankan streak-mu!', 'Keep your streak going!');
  ...
  String get noExamHistory =>
      _t('Belum ada riwayat ujian.', 'No exam history yet.');
  ...
  String get logoutConfirmTitle =>
      _t('Keluar dari akun?', 'Log out of your account?');
  ...
  String get resultGood =>
      _t('Bagus, terus berlatih!', 'Good, keep practicing!');
  ...
  String radicalPill(String radical) =>
      _t('Radikal $radical', 'Radical $radical');
  ...
  String get whatIsKanjiMeaning =>
      _t('Apa arti kanji ini?', "What does this kanji mean?");
  ...
  String get whatIsWordMeaning =>
      _t('Apa arti kata ini?', 'What does this word mean?');
  ...
  String get similarParticlesTitle =>
      _t('Partikel Serupa', 'Similar Particles');
  ...
  String get searchHint => _t(
    'Cari kanji, hiragana, romaji, atau arti...',
    'Search kanji, hiragana, romaji, or meaning...',
  );
  ...
  String get noRankingData =>
      _t('Belum ada data peringkat.', 'No ranking data yet.');

  // --- Public profile (tapping a ranked row) ---
  String get publicProfileTitle => _t('Profil', 'Profile');
  String get curriculumProgressTitle =>
      _t('Progres Kurikulum', 'Curriculum Progress');
  ...
  String kickConfirmTitle(String name) => _t('Tendang $name?', 'Kick $name?');
  ...
  String get kickFailed => _t(
    'Gagal menendang anggota, coba lagi.',
    'Failed to kick member, try again.',
  );
  ...
  String get alreadyMemberError => _t(
    'Learner ini sudah ada di dalam clan.',
    'This learner is already in the clan.',
  );
  ...
  String topClanMembers(int count) => _t('$count anggota', '$count members');
  String topClanScorePoints(String score) => _t('$score poin', '$score points');
  ...
  String blockConfirmTitle(String name) => _t('Blokir $name?', 'Block $name?');
  ...
  String get blockActionFailed =>
      _t('Gagal memproses, coba lagi.', 'Failed to process, try again.');
  String get reportMessage => _t('Laporkan', 'Report');
  String get reportMessageTitle => _t('Laporkan Pesan', 'Report Message');
  ...
  String get postAnnouncementButton =>
      _t('Kirim Pengumuman', 'Post Announcement');
  ...
  String failedToLoadAnnouncements(Object e) =>
      _t('Gagal memuat pengumuman: $e', 'Failed to load announcements: $e');
  ...
  String failedToLoadNotifications(Object e) =>
      _t('Gagal memuat notifikasi: $e', 'Failed to load notifications: $e');
  ...
  String get kanjiComboCategorySubtitle => _t(
    'Kanji tunggal atau kombinasi kata',
    'Single kanji or word combinations',
  );
  ...
  String get failedToSaveExamResult => _t(
    'Gagal menyimpan hasil ujian, coba lagi.',
    'Failed to save exam result, try again.',
  );
  String get noQuestionsAvailable =>
      _t('Soal tidak tersedia', 'No questions available');
  ...
  String get tutorialReplay =>
      _t('Lihat Tutorial Lagi', 'Watch Tutorial Again');
  ...
  String get cardTutorialReady =>
      _t('Ayo cari lawan pertamamu!', "Let's find your first opponent!");
  String get cardTutorialStart => _t('Mulai Bertanding', 'Start Battling');
  String get cardTutorialReplay => _t('Cara Bermain', 'How to Play');
  ...
  String get coachCorrect4 =>
      _t('Bagus, terus begitu.', 'Nice, just like that.');
  ...
  String coachWrong1(String answer) => _t(
    'Belum tepat. Jawabannya $answer.',
    'Not quite. The answer is $answer.',
  );
  String coachWrong2(String answer) =>
      _t('Hampir! Yang benar $answer.', 'So close! It is $answer.');
  String coachWrong3(String answer) => _t(
    'Tidak apa-apa, ini $answer. Ingat ya!',
    'That is okay — it is $answer. Remember it!',
  );
  String coachWrong4(String answer) => _t(
    'Kita catat: $answer. Coba lagi nanti.',
    'Let us note it: $answer. Try again later.',
  );

  String coachFinishedStrong1(int score, int total) => _t(
    'Selesai! $score dari $total benar. Hebat!',
    'Done! $score of $total correct. Excellent!',
  );
  String coachFinishedStrong2(int score, int total) => _t(
    '$score dari $total. Aku bangga sama kamu!',
    '$score out of $total. I am proud of you!',
  );
  String coachPerfect1(int total) => _t(
    'Sempurna! $total dari $total benar!',
    'Perfect! $total out of $total!',
  );
  String coachPerfect2(int total) =>
      _t('Tidak ada yang salah sama sekali!', 'Not a single one missed!');
  String coachFinishedWeak1(int score, int total) => _t(
    'Selesai! $score dari $total. Ayo coba lagi, pasti bisa.',
    'Done! $score of $total. Try again — you will get there.',
  );
  String coachFinishedWeak2(int score, int total) => _t(
    '$score dari $total. Belajar lagi sebentar, yuk!',
  ...
  String get examResultTitleGreat =>
      _t('Hebat! Ujian Selesai 🎉', 'Great! Exam Complete 🎉');
  String get examResultTitleGood =>
      _t('Bagus! Terus Berlatih 👍', 'Good! Keep Practicing 👍');
  ...
  String get simpleExamResultGood =>
      _t('Bagus, terus berlatih! 👍', 'Good, keep practicing! 👍');
  ...
  String get deleteWordConfirmTitle =>
      _t('Hapus kata ini?', 'Delete this word?');
  String get deleteWordConfirmBody => _t(
    'Kata yang dihapus tidak bisa dikembalikan.',
    'A deleted word cannot be recovered.',
  );
  String appVersionLabel(String version) =>
      _t('Versi $version', 'Version $version');
  ...
  String get storeUnavailable => _t(
    'Toko aplikasi tidak tersedia di perangkat ini.',
  ...
  String get previewUnlockFailed => _t(
    'Gagal membuka preview, coba lagi.',
    'Failed to unlock preview, try again.',
  );
  ...
  String get adNotReadyYet => _t(
    'Iklan belum tersedia, coba lagi sebentar lagi.',
  ...
  String get noCameraAvailable => _t(
  ...
  String get cameraOpenFailed => _t(
    ...
    'Failed to open camera. Try again.',
  );
  ...
  String get resumeDetectionTooltip =>
      _t('Lanjutkan Deteksi', 'Resume Detection');
  String get pauseDetectionTooltip => _t('Jeda Deteksi', 'Pause Detection');
  String get meaningNotAvailable =>
      _t('Arti belum tersedia', 'Meaning not available yet');
  String get registerUsageTitle =>
      _t('Register / Cara Pakai', 'Register / Usage');

  // --- Modules coming soon ---
  String get moduleInDevelopment => _t(
    'Modul ini sedang dalam pengembangan',
    'This module is under development',
  );
  String get remindMeButton => _t('Ingatkan Saya', 'Remind Me');
  String get willRemindYou => _t(
    'Kami akan mengingatkanmu saat modul ini siap!',
    "We'll remind you when this module is ready!",
  );
  String get viewPremiumOptionsButton =>
      _t('Lihat Opsi Premium', 'View Premium Options');
  ...
  String get watchAdAndSaveButton =>
      _t('Nonton Iklan & Simpan', 'Watch Ad & Save');
  String get nameSaveFailed =>
      _t('Gagal menyimpan nama, coba lagi.', 'Failed to save name, try again.');
  String get adLoadFailed =>
      _t('Gagal memuat iklan, coba lagi.', 'Failed to load ad, try again.');
  String get pickCoverTitle => _t('Pilih Sampul', 'Choose Cover');
  String get coverSaveFailed => _t(
    'Gagal menyimpan sampul, coba lagi.',
    'Failed to save cover, try again.',
  );
  ...
  String get babGuideIntro => _t('Ayo mulai Bab 1!', 'Let\'s start Bab 1!');
  ...
  String get babGuideDoneMessage => _t(
    'Kerja bagus! Bab ini sudah selesai.',
    'Great job! This chapter is done.',
  );
  ...
  String get ageQuestionTitle =>
      _t('Tahun berapa kamu lahir?', 'What year were you born?');
  ...
  String get tapCardForMeaning =>
      _t('tekan kartu untuk melihat arti', 'tap the card to see its meaning');
  ...
  String get showAllStrokesNumbered =>
      _t('Tampilkan semua goresan bernomor', 'Show all strokes, numbered');
  ...
  String get battleWaitingForOpponent =>
      _t('Menunggu jawaban lawan...', "Waiting for opponent's answer...");
  ...
  String get battleTestCreateButton => _t('Buat Pertandingan', 'Create Match');
  ...
  String get battleDebugTooltip =>
      _t('DEBUG uji coba pertandingan', 'DEBUG battle test');
  ...
  String battleChallengeTitle(String targetName) => _t(
    'Tantang $targetName Bertanding Kartu',
    'Challenge $targetName to a Card Match',
  );
  ...
  String get battleInviteCancel => _t('Batalkan Tantangan', 'Cancel Challenge');
  ...
  String get battleMatchmakingTitle => _t('Cari Lawan', 'Find an Opponent');
  ...
  String battleHandRemaining(int left, int total) =>
      _t('$left / $total', '$left / $total');
  ...
  String get rankSkipPickTier =>
      _t('Mau lompat ke mana?', 'Skip to which rank?');
  ...
  String rankSkipProgress(int at, int total) =>
      _t('Kartu $at / $total', 'Card $at / $total');
  String get rankSkipAtTop =>
      _t('Kamu sudah di rank tertinggi.', 'You are already at the top rank.');
  String get rankSkipPassed => _t('Lulus!', 'Passed!');
  String get rankSkipFailed => _t('Belum lulus', 'Not this time');
  String rankSkipScore(int correct, int total) =>
      _t('Benar $correct dari $total', '$correct of $total correct');
  String rankSkipPromoted(String tier) =>
      _t('Rank kamu sekarang $tier.', 'Your rank is now $tier.');
  ...
  String rankSkipRetryAfter(String when) =>
      _t('Bisa dicoba lagi $when.', 'You can try again $when.');

  /// "besok 01.48" — the day matters, because the wait is a whole one.
  /// Shown as a bare time it read as a few minutes away.
  String rankSkipTomorrowAt(String time) =>
      _t('besok pukul $time', 'tomorrow at $time');
  String rankSkipTodayAt(String time) => _t('pukul $time', 'at $time');
  String get rankSkipRetryTomorrow =>
      _t('Bisa dicoba lagi besok.', 'You can try again tomorrow.');
  ...
  String get rankSkipAnswerEmpty => _t('(belum diisi)', '(nothing typed yet)');
  String get rankSkipCardMissing => _t(
    'Kartu ini tidak bisa dimuat. Tekan lanjut untuk soal berikutnya.',
    'This card could not be loaded. Press next for the following one.',
  );
  String get rankSkipYourAnswer => _t('Jawabanmu', 'Your answer');
  String get battleCardPickerHint =>
      _t('Ketuk salah satu kartu untuk memilihnya', 'Tap a card to choose it');
  String get battleCardPickerSend => _t('Kirim ke Lawan', 'Send to Opponent');
  String get cardGameWordmark => _t('TEISOU BATTLE', 'TEISOU BATTLE');
  String get cardGameWordmarkSub => _t('Card Battle Kana', 'Card Battle Kana');
  ...
  String get battleMatchmakingSearchButton => _t('Cari Lawan', 'Find Opponent');
  ...
  String get matchOutcomeUnfinished => _t('Belum selesai', 'Unfinished');
  String get matchOutcomeDraw => _t('Seri', 'Draw');
  String matchAgainst(String opponent) => _t('lawan $opponent', 'vs $opponent');
  ...
  String battleStarsGained(int delta) => _t('+$delta bintang', '+$delta stars');
