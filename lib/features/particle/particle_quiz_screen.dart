...
/// screen.
class ParticleQuizScreen extends StatefulWidget {
  ...
  @override
  State<ParticleQuizScreen> createState() => _ParticleQuizScreenState();
}
...
class _ParticleQuizScreenState extends State<ParticleQuizScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: Text('Kuis · Partikel ${widget.categoryName}')),
      body: SafeArea(
        child: finished
