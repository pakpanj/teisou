...
/// Entry point for the Kaiwa module: scenario picker (Perkenalan / Di
/// Restoran / ...). Only categories with a real dataset are tappable; the
/// rest show a "Segera" badge, same convention as ParticleHomeScreen's
/// category picker.
class KaiwaHomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final categoriesAsync = ref.watch(kaiwaCategoriesProvider);
