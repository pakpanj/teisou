      ...
      children: [
        Material(
          ...
          child: InkWell(
            ...
            // The clip text is a script with 男：/女： markers, so the
            // speakers are stated outright — no guessing needed, and the
            // markers stop being read out as words.
            onTap: () =>
                ref.read(ttsServiceProvider).speakScript(clip.audioText),
            child: const Padding(
