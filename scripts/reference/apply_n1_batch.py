"""Splice scripts/reference/n1_web_batch.py's 123 words into the right
generate_kotoba_*.py files as new tuples. Run from teisou project root:
python scripts/reference/apply_n1_batch.py
"""
import json
import re
import sys
...
from n1_web_batch import N1_WORDS  # noqa: E402
...
def build_tuples():
    ...
    out = {}
    for kanji, reading, meaning, cat, ex_ja, ex_ro, ex_id in N1_WORDS:
        ...
        if script in TWELVE_FIELD_SCRIPTS:
            tup = (
                ...
                f'"N1", "noun", {kanji_lit}, {romaji_lit}, {kanji_lit}, {romaji_lit}, [\n'
                f'            ({ex_ja_lit}, {ex_ro_lit}, {ex_id_lit}),\n'
                f'        ]),\n'
            )
        else:
            tup = (
                f'        ("{suffix}", {kanji_lit}, {reading_lit}, {romaji_lit}, {meaning_lit}, "N1", [\n'
                f'            ({ex_ja_lit}, {ex_ro_lit}, {ex_id_lit}),\n'
                f'        ]),\n'
            )
