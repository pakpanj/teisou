...
STATUS (update this line every time a category is finished):
    Done (17): all of "Alam & Lingkungan" (10) + all of "Makanan &
    Minuman" (7: makanan_jepang, makanan_indonesia, makanan_barat,
    minuman, bumbu_rempah, peralatan_masak, cara_memasak) = 234/1266
    words. Remaining: 28 categories, 1032 words.
