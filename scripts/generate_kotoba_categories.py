...
GROUPS = {
    ...
    "Tubuh & Kesehatan": [
        ("anggota_tubuh", "Anggota Tubuh", "🖐️", True, 28),
        ("penyakit_gejala", "Penyakit & Gejala", "🤒", True, 34),
        ("obat_obatan", "Obat-obatan", "💊", True, 23),
        ("olahraga", "Olahraga", "⚽", True, 26),
        ("perasaan_emosi", "Perasaan & Emosi", "😊", True, 53),
        ("ekspresi_wajah", "Ekspresi Wajah", "😮", True, 10),
    ],
    "Tempat & Transportasi": [
        ("ruangan_rumah", "Ruangan di Rumah", "🚪", True, 18),
        ("perabot_rumah", "Perabot Rumah", "🛋️", True, 19),
        ("bangunan_fasilitas", "Bangunan & Fasilitas", "🏢", True, 52),
        ("kendaraan", "Kendaraan", "🚗", True, 33),
        ("arah_lokasi", "Arah & Lokasi", "🧭", True, 33),
        ("negara_kota", "Negara & Kota", "🗺️", True, 46),
    ],
    "Manusia & Sosial": [
        ("profesi", "Profesi", "👨‍⚕️", True, 37),
        ("keluarga_hubungan", "Keluarga & Hubungan", "👪", True, 49),
        ("pakaian_aksesori", "Pakaian & Aksesori", "👕", True, 21),
        ("hobi_aktivitas", "Hobi & Aktivitas", "🎨", True, 31),
        ("agama_budaya", "Agama & Budaya", "⛩️", True, 15),
        ...
        ("konsep_umum", "Konsep Umum", "💭", True, 375),
    ],
    "Pendidikan & Pekerjaan": [
        ("alat_tulis_sekolah", "Alat Tulis & Perlengkapan Sekolah", "✏️", True, 20),
        ("mata_pelajaran", "Mata Pelajaran", "📖", True, 50),
        ("pekerjaan_kantor", "Pekerjaan & Kantor", "💼", True, 107),
        ("teknologi_gadget", "Teknologi & Gadget", "💻", True, 36),
        ("media_hiburan", "Media & Hiburan", "📺", True, 25),
    ],
    "Waktu & Angka": [
        ("hari_bulan", "Hari & Bulan", "📅", True, 74),
        ("musim", "Musim", "🍂", True, 5),
