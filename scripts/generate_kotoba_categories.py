...
GROUPS = {
    ...
    "Tubuh & Kesehatan": [
        ...
        ("olahraga", "Olahraga", "⚽", True, 25),
        ("perasaan_emosi", "Perasaan & Emosi", "😊", True, 37),
        ("ekspresi_wajah", "Ekspresi Wajah", "😮", True, 9),
    ],
    "Tempat & Transportasi": [
        ("ruangan_rumah", "Ruangan di Rumah", "🚪", True, 18),
        ("perabot_rumah", "Perabot Rumah", "🛋️", True, 19),
        ("bangunan_fasilitas", "Bangunan & Fasilitas", "🏢", True, 50),
        ("kendaraan", "Kendaraan", "🚗", True, 32),
        ("arah_lokasi", "Arah & Lokasi", "🧭", True, 30),
        ("negara_kota", "Negara & Kota", "🗺️", True, 34),
    ],
    "Manusia & Sosial": [
        ("profesi", "Profesi", "👨‍⚕️", True, 35),
        ("keluarga_hubungan", "Keluarga & Hubungan", "👪", True, 47),
        ("pakaian_aksesori", "Pakaian & Aksesori", "👕", True, 21),
        ("hobi_aktivitas", "Hobi & Aktivitas", "🎨", True, 30),
        ...
        ("konsep_umum", "Konsep Umum", "💭", True, 317),
    ],
    "Pendidikan & Pekerjaan": [
        ("alat_tulis_sekolah", "Alat Tulis & Perlengkapan Sekolah", "✏️", True, 20),
        ("mata_pelajaran", "Mata Pelajaran", "📖", True, 48),
        ("pekerjaan_kantor", "Pekerjaan & Kantor", "💼", True, 92),
        ("teknologi_gadget", "Teknologi & Gadget", "💻", True, 34),
        ("media_hiburan", "Media & Hiburan", "📺", True, 25),
    ],
    "Waktu & Angka": [
        ("hari_bulan", "Hari & Bulan", "📅", True, 72),
        ("musim", "Musim", "🍂", True, 5),
