...
N5_ENTRIES = [
    ...
    (
        "toshokan_benkyou_jikan_encho",
        "Pengumuman Perpanjangan Waktu Belajar di Perpustakaan",
        "来月から、図書館の利用時間が長くなります。今までは午後五時"
        "まででしたが、これからは午後七時まで使えます。テスト前に"
        "勉強したい人は、ぜひ利用してください。",
        "Mulai bulan depan, jam penggunaan perpustakaan menjadi lebih "
        "panjang. Sampai sekarang jam 5 sore, tapi mulai sekarang bisa "
        "digunakan sampai jam 7 malam. Yang ingin belajar sebelum "
        "ujian, silakan manfaatkan.",
        [
            ("図書館の利用時間はどうなりますか。", ["長くなる", "短くなる", "変わらない", "なくなる"], 0),
            ("これからは何時まで使えますか。", ["午後七時", "午後五時", "午後六時", "午後八時"], 0),
            ("誰に利用を勧めていますか。", ["テスト前に勉強したい人", "遊びたい人", "寝たい人", "運動したい人"], 0),
        ],
    ),
    (
        "shouboushomi_kengaku",
        "Jadwal Kunjungan ke Pemadam Kebakaran",
        "来週の金曜日、クラスで消防署へ見学に行きます。消防車を見た"
        "り、消防士の話を聞いたりします。集合は午前九時半に学校の"
        "玄関前です。",
        "Jumat minggu depan, kelas kami akan berkunjung ke pemadam "
        "kebakaran. Kami akan melihat mobil pemadam dan mendengar "
        "cerita dari petugas pemadam. Berkumpul jam setengah sepuluh "
        "pagi di depan pintu masuk sekolah.",
        [
            ("どこへ見学に行きますか。", ["消防署", "警察署", "病院", "市役所"], 0),
            ("見学で何をしますか。", ["消防車を見たり消防士の話を聞いたりする", "本を読む", "勉強する", "走る"], 0),
            ("集合はいつですか。", ["午前九時半", "午前八時", "午後一時", "午後三時"], 0),
        ],
    ),
    (
        "inaka_itoko_tegami",
        "Surat dari Sepupu di Desa",
        "元気ですか。田舎の生活は都会と違って、静かでのんびりしてい"
        "ます。毎朝、鳥の声で目が覚めます。今度、夏休みに遊びに来て"
        "ください。一緒に川で泳ぎましょう。",
        "Apa kabar? Kehidupan di desa berbeda dari kota, tenang dan "
        "santai. Setiap pagi, saya terbangun oleh suara burung. "
        "Nanti, saat liburan musim panas, datanglah bermain. Mari "
        "berenang bersama di sungai.",
        [
            ("田舎の生活は都会と比べてどうですか。", ["静かでのんびりしている", "うるさくて忙しい", "同じ", "つまらない"], 0),
            ("毎朝何で目が覚めますか。", ["鳥の声", "目覚まし時計", "車の音", "雨の音"], 0),
            ("何に誘っていますか。", ["川で泳ぐこと", "山に登ること", "買い物すること", "勉強すること"], 0),
        ],
    ),
    (
        "kazoku_yuushoku_menu",
        "Menu Makan Malam Keluarga",
        "今日の夕食は、みんなが好きな焼き魚とみそ汁と野菜サラダです。"
        "デザートに果物もあります。家族みんなで一緒に食べる時間は、"
        "とても楽しいです。",
        "Makan malam hari ini adalah ikan bakar, sup miso, dan salad "
        "sayur yang disukai semua orang. Ada juga buah untuk pencuci "
        "mulut. Waktu makan bersama seluruh keluarga sangat "
        "menyenangkan.",
        [
            ("今日の夕食は何ですか。", ["焼き魚とみそ汁と野菜サラダ", "カレーとサラダ", "ラーメンとぎょうざ", "パンとスープ"], 0),
            ("デザートは何ですか。", ["果物", "ケーキ", "アイスクリーム", "プリン"], 0),
            ("筆者はどう感じていますか。", ["家族と食べる時間はとても楽しい", "一人で食べたい", "料理が嫌い", "早く終わらせたい"], 0),
        ],
    ),
    (
        "origami_kyoushitsu_oshirase",
        "Pengumuman Kelas Origami",
        "来週の水曜日、放課後に折り紙教室があります。場所は図書室"
        "です。折り紙を持っていない人には、学校が用意します。誰でも"
        "参加できます。",
        "Rabu minggu depan, ada kelas origami setelah pulang sekolah. "
        "Tempatnya di ruang perpustakaan. Bagi yang tidak punya kertas "
        "origami, sekolah akan menyiapkan. Siapa saja bisa ikut.",
        [
            ("折り紙教室はいつですか。", ["来週の水曜日の放課後", "今週の月曜日", "来月の金曜日", "毎日"], 0),
            ("場所はどこですか。", ["図書室", "体育館", "音楽室", "教室"], 0),
            ("折り紙を持っていない人はどうしますか。", ["学校が用意する", "参加できない", "友達に借りる", "買いに行く"], 0),
        ],
    ),
    (
        "hana_ue_gakkou_hanashi",
        "Cerita Menanam Bunga di Sekolah",
        "先週、クラスで花を植えました。土を掘って、種をまいて、水を"
        "あげました。毎日水をあげるのが私の係です。花が咲くのが"
        "楽しみです。",
        "Minggu lalu, kelas kami menanam bunga. Kami menggali tanah, "
        "menabur benih, dan menyiram air. Menyiram air setiap hari "
        "adalah tugas saya. Saya menantikan bunga itu mekar.",
        [
            ("先週クラスで何をしましたか。", ["花を植えた", "絵を描いた", "歌を歌った", "本を読んだ"], 0),
            ("私の係は何ですか。", ["毎日水をあげること", "土を掘ること", "種をまくこと", "花を切ること"], 0),
            ("何を楽しみにしていますか。", ["花が咲くこと", "夏休み", "テスト", "給食"], 0),
        ],
    ),
    (
        "basuke_renshuu_jikanwari",
        "Jadwal Latihan Klub Basket",
        "バスケットボール部の練習は月曜日、水曜日、金曜日です。時間"
        "は放課後三時から五時までです。試合は来月の第三日曜日に"
        "あります。",
        "Latihan klub basket adalah hari Senin, Rabu, Jumat. Waktunya "
        "setelah pulang sekolah jam 3 sampai jam 5. Pertandingannya "
        "ada hari Minggu ketiga bulan depan.",
        [
            ("練習は何曜日ですか。", ["月曜日、水曜日、金曜日", "火曜日、木曜日", "土曜日、日曜日", "毎日"], 0),
            ("練習の時間は何時から何時までですか。", ["三時から五時", "二時から四時", "四時から六時", "一時から三時"], 0),
            ("試合はいつですか。", ["来月の第三日曜日", "今月の第三日曜日", "来週の日曜日", "来年"], 0),
        ],
    ),
    (
        "furuhon_koukan_oshirase",
        "Pengumuman Pertukaran Buku Bekas",
        "来月、学校で古本交換会をします。読み終わった本を持ってきて、"
        "他の人の本と交換できます。本を大切にする気持ちも学べます。",
        "Bulan depan, sekolah akan mengadakan acara tukar buku bekas. "
        "Bawa buku yang sudah selesai dibaca, dan bisa ditukar dengan "
        "buku orang lain. Kita juga bisa belajar rasa menghargai "
        "buku.",
        [
            ("何を持ってきますか。", ["読み終わった本", "新しい本", "ノート", "お金"], 0),
            ("本はどうなりますか。", ["他の人の本と交換できる", "捨てられる", "売られる", "燃やされる"], 0),
            ("この会で何が学べますか。", ["本を大切にする気持ち", "お金の使い方", "料理の仕方", "スポーツ"], 0),
        ],
    ),
    (
        "shinnen_aisatsu_tegami",
        "Surat Ucapan Selamat Tahun Baru",
        "明けましておめでとうございます。今年もよろしくお願いします。"
        "去年はたくさん助けてもらって、ありがとうございました。今年"
        "はもっと元気に頑張ります。",
        "Selamat Tahun Baru. Mohon bimbingannya juga tahun ini. Tahun "
        "lalu banyak dibantu, terima kasih. Tahun ini saya akan lebih "
        "bersemangat berusaha.",
        [
            ("この手紙は何のあいさつですか。", ["新年のあいさつ", "誕生日のあいさつ", "卒業のあいさつ", "お礼のあいさつだけ"], 0),
            ("去年について何と言っていますか。", ["たくさん助けてもらった", "何もなかった", "大変だった", "楽しくなかった"], 0),
            ("今年はどうすると言っていますか。", ["もっと元気に頑張る", "休む", "何もしない", "引っ越す"], 0),
        ],
    ),
    (
        "sofu_kaen_tetsudai",
        "Cerita Membantu Kakek di Kebun",
        "日曜日、祖父の畑を手伝いに行きました。トマトとナスを収穫し"
        "ました。祖父は「ありがとう、助かったよ」と言ってくれました。"
        "とてもうれしかったです。",
        "Hari Minggu, saya pergi membantu di kebun kakek. Kami memanen "
        "tomat dan terong. Kakek berkata \"terima kasih, sangat "
        "terbantu.\" Saya sangat senang.",
        [
            ("どこへ手伝いに行きましたか。", ["祖父の畑", "祖母の家", "学校の花壇", "公園"], 0),
            ("何を収穫しましたか。", ["トマトとナス", "キュウリとイモ", "お米", "果物"], 0),
            ("祖父は何と言いましたか。", ["ありがとう、助かったよ", "もう来なくていいよ", "疲れたよ", "早く帰りなさい"], 0),
        ],
    ),
    (
        "jishin_hinan_kunren_oshirase",
        "Pengumuman Latihan Evakuasi Gempa",
        "来週の木曜日、学校で地震の避難訓練をします。「地震です」と"
        "いう放送を聞いたら、机の下に隠れてください。その後、先生の"
        "指示で校庭に避難します。",
        "Kamis minggu depan, sekolah akan mengadakan latihan evakuasi "
        "gempa. Jika mendengar pengumuman \"gempa bumi\", sembunyilah "
        "di bawah meja. Setelah itu, evakuasi ke lapangan sekolah "
        "sesuai instruksi guru.",
        [
            ("いつ避難訓練をしますか。", ["来週の木曜日", "今週の月曜日", "来月", "毎日"], 0),
            ("「地震です」という放送を聞いたらどうしますか。", ["机の下に隠れる", "外に走って出る", "窓を開ける", "歌う"], 0),
            ("その後どこに避難しますか。", ["校庭", "体育館", "教室", "図書室"], 0),
        ],
    ),
    (
        "shodou_kyoushitsu_jikanwari",
        "Jadwal Kelas Kaligrafi",
        "書道教室は毎週土曜日の午前十時からです。筆と墨は教室で借り"
        "られます。初めての人も大歓迎です。",
        "Kelas kaligrafi ada setiap Sabtu jam 10 pagi. Kuas dan tinta "
        "bisa dipinjam di kelas. Pemula pun sangat disambut.",
        [
            ("書道教室はいつですか。", ["毎週土曜日の午前十時", "毎週日曜日", "毎日", "月に一度"], 0),
            ("筆と墨はどうしますか。", ["教室で借りられる", "自分で買う", "必要ない", "友達に借りる"], 0),
            ("初めての人はどうですか。", ["大歓迎", "参加できない", "別料金が必要", "難しすぎる"], 0),
        ],
    ),
    (
        "atarashii_gakkou_tomodachi_tegami",
        "Surat dari Teman di Sekolah Baru",
        "元気ですか。新しい学校には少しずつ慣れてきました。クラスに"
        "優しい友達ができて、うれしいです。今度、遊びに行ってもいい"
        "ですか。",
        "Apa kabar? Sedikit demi sedikit sudah mulai terbiasa dengan "
        "sekolah baru. Senang karena punya teman baik di kelas. "
        "Nanti, boleh saya main ke sana?",
        [
            ("新しい学校にはどうなってきましたか。", ["少しずつ慣れてきた", "全く慣れない", "すぐに嫌になった", "何も変わらない"], 0),
            ("クラスに何ができましたか。", ["優しい友達", "怖い先生", "難しい宿題", "新しい教科書"], 0),
            ("何をお願いしていますか。", ["遊びに行ってもいいか", "お金を貸してほしいか", "一緒に引っ越すか", "本を送ってほしいか"], 0),
        ],
    ),
    (
        "piknikku_bentou_menu",
        "Menu Bekal untuk Piknik",
        "明日のピクニックのお弁当は、おにぎりと卵焼きとから揚げに"
        "します。デザートにいちごも持っていきます。みんなで公園で"
        "食べるのが楽しみです。",
        "Bekal piknik besok akan berisi onigiri, telur dadar gulung, "
        "dan ayam goreng. Buah stroberi juga dibawa untuk pencuci "
        "mulut. Menantikan makan bersama di taman.",
        [
            ("明日のお弁当は何ですか。", ["おにぎりと卵焼きとから揚げ", "パンとスープ", "カレーライス", "うどん"], 0),
            ("デザートは何を持っていきますか。", ["いちご", "りんご", "バナナ", "メロン"], 0),
            ("どこで食べますか。", ["公園", "学校", "家", "レストラン"], 0),
        ],
    ),
    (
        "basuke_court_shuuri_oshirase",
        "Pengumuman Perbaikan Lapangan Basket",
        "来週から二週間、体育館のバスケットコートを修理します。その"
        "間、バスケ部は校庭で練習します。ご協力をお願いします。",
        "Mulai minggu depan selama dua minggu, lapangan basket di gym "
        "akan diperbaiki. Selama itu, klub basket berlatih di lapangan "
        "sekolah. Mohon kerja samanya.",
        [
            ("何を修理しますか。", ["体育館のバスケットコート", "校庭", "プール", "教室"], 0),
            ("どのくらいの期間修理しますか。", ["二週間", "一週間", "一ヶ月", "三日間"], 0),
            ("その間バスケ部はどこで練習しますか。", ["校庭", "公園", "家", "別の学校"], 0),
        ],
    ),
    (
        "haha_ryouri_tetsudai",
        "Cerita Membantu Ibu Memasak",
        "今日、母と一緒に夕食を作りました。私は野菜を切る係でした。"
        "少し難しかったけれど、最後まで頑張りました。家族に「おいし"
        "い」と言われて、とてもうれしかったです。",
        "Hari ini, saya memasak makan malam bersama ibu. Tugas saya "
        "memotong sayuran. Agak sulit, tapi saya berusaha sampai "
        "selesai. Sangat senang saat keluarga bilang \"enak\".",
        [
            ("誰と夕食を作りましたか。", ["母", "父", "姉", "祖母"], 0),
            ("私の係は何でしたか。", ["野菜を切ること", "肉を焼くこと", "お皿を洗うこと", "お米を炊くこと"], 0),
            ("家族に何と言われましたか。", ["おいしい", "まずい", "もういい", "早く食べて"], 0),
        ],
    ),
    (
        "dance_bu_renshuu_jikanwari",
        "Jadwal Latihan Klub Menari",
        "ダンス部の練習は火曜日と木曜日と土曜日です。場所はいつも"
        "音楽室の隣のダンス室です。発表会は文化祭の日にあります。",
        "Latihan klub menari adalah hari Selasa, Kamis, dan Sabtu. "
        "Tempatnya selalu di ruang tari sebelah ruang musik. "
        "Pertunjukannya ada di hari festival budaya.",
        [
            ("練習は何曜日ですか。", ["火曜日と木曜日と土曜日", "月曜日と水曜日", "毎日", "日曜日だけ"], 0),
            ("練習の場所はどこですか。", ["ダンス室", "体育館", "校庭", "図書室"], 0),
            ("発表会はいつありますか。", ["文化祭の日", "運動会の日", "入学式の日", "卒業式の日"], 0),
        ],
    ),
    (
        "kenkou_shindan_oshirase",
        "Pengumuman Pemeriksaan Kesehatan Sekolah",
        "来週、学校で健康診断があります。身長と体重を測ったり、目や"
        "耳の検査をしたりします。体操服を持ってきてください。",
        "Minggu depan, ada pemeriksaan kesehatan di sekolah. Akan "
        "diukur tinggi dan berat badan, serta diperiksa mata dan "
        "telinga. Silakan bawa baju olahraga.",
        [
            ("いつ健康診断がありますか。", ["来週", "今週", "来月", "今日"], 0),
            ("何を測りますか。", ["身長と体重", "視力だけ", "体温だけ", "血圧"], 0),
            ("何を持ってきますか。", ["体操服", "水着", "傘", "本"], 0),
        ],
    ),
    (
        "oyagata_kansha_tegami",
        "Surat Ucapan Terima Kasih untuk Orang Tua",
        "お父さん、お母さんへ。いつも私のために頑張ってくれて、あり"
        "がとうございます。おいしいご飯や、優しい言葉、全部うれしい"
        "です。これからも家族みんなで仲良く過ごしたいです。",
        "Kepada Ayah, Ibu. Terima kasih selalu berusaha keras demi "
        "saya. Makanan yang enak, kata-kata yang lembut, semuanya "
        "membuat saya senang. Mulai sekarang pun, saya ingin terus "
        "hidup rukun bersama seluruh keluarga.",
        [
            ("この手紙は誰への手紙ですか。", ["お父さんとお母さん", "先生", "友達", "祖父母"], 0),
            ("何がうれしいと言っていますか。", ["おいしいご飯や優しい言葉", "高いおもちゃ", "新しい服", "お金"], 0),
            ("これからどうしたいと言っていますか。", ["家族みんなで仲良く過ごしたい", "一人で暮らしたい", "引っ越したい", "早く大人になりたい"], 0),
        ],
    ),
    (
        "yuki_asobi_fuyu_hanashi",
        "Cerita Bermain Salju di Musim Dingin",
        "冬休みに、家族で雪が多い場所へ旅行に行きました。初めて雪だ"
        "るまを作りました。雪合戦もして、とても楽しかったです。手は"
        "冷たかったけれど、心はあたたかい気持ちでした。",
        "Saat liburan musim dingin, saya bertamasya bersama keluarga "
        "ke tempat yang banyak salju. Untuk pertama kalinya membuat "
        "manusia salju. Bermain perang salju juga, sangat "
        "menyenangkan. Tangan dingin, tapi hati terasa hangat.",
        [
            ("冬休みにどこへ行きましたか。", ["雪が多い場所", "海", "山だけ", "外国"], 0),
            ("初めて何を作りましたか。", ["雪だるま", "おにぎり", "凧", "船"], 0),
            ("手はどうでしたが、心はどうでしたか。", ["手は冷たかったが心はあたたかかった", "手も心も冷たかった", "手も心もあたたかかった", "何も感じなかった"], 0),
        ],
    ),
    (
        "suiei_kyoushitsu_natsu_jikanwari",
        "Jadwal Kelas Renang Musim Panas",
        "夏休みの水泳教室は七月と八月の毎週火曜日と木曜日です。プー"
        "ルに入る前に、必ずシャワーを浴びてください。水着と帽子を"
        "忘れずに持ってきてください。",
        "Kelas renang liburan musim panas adalah setiap Selasa dan "
        "Kamis di bulan Juli dan Agustus. Sebelum masuk kolam, "
        "pastikan mandi shower dulu. Jangan lupa membawa baju renang "
        "dan topi renang.",
        [
            ("水泳教室はいつですか。", ["七月と八月の毎週火曜日と木曜日", "毎日", "九月だけ", "土曜日だけ"], 0),
            ("プールに入る前に何をしますか。", ["シャワーを浴びる", "水を飲む", "準備体操だけする", "走る"], 0),
            ("何を忘れずに持ってきますか。", ["水着と帽子", "タオルだけ", "本", "お弁当"], 0),
        ],
    ),
    (
        "gaikoku_hikkoshi_tomodachi_tegami",
        "Surat dari Teman yang Pindah ke Luar Negeri",
        "元気ですか。父の仕事で、来月から外国に住むことになりました。"
        "新しい学校は少し心配ですが、頑張ります。日本に帰ったら、"
        "また一緒に遊んでくださいね。",
        "Apa kabar? Karena pekerjaan ayah, mulai bulan depan saya "
        "akan tinggal di luar negeri. Sekolah baru sedikit membuat "
        "khawatir, tapi saya akan berusaha. Kalau kembali ke Jepang, "
        "ayo main bersama lagi ya.",
        [
            ("なぜ外国に住むことになりましたか。", ["父の仕事のため", "母の仕事のため", "勉強のため", "旅行のため"], 0),
            ("新しい学校についてどう感じていますか。", ["少し心配", "とても楽しみ", "何も感じない", "嫌だ"], 0),
            ("日本に帰ったら何をしたいと言っていますか。", ["また一緒に遊ぶこと", "勉強すること", "引っ越すこと", "働くこと"], 0),
        ],
    ),
    (
        "undoubi_hiruhan_menu",
        "Menu Makan Siang di Hari Olahraga",
        "運動会の日のお弁当は、みんなで食べる特別なお弁当です。おに"
        "ぎり、から揚げ、卵焼き、そしてゼリーもあります。家族と一緒"
        "に、芝生の上で食べます。",
        "Bekal di hari olahraga adalah bekal spesial yang dimakan "
        "bersama-sama. Ada onigiri, ayam goreng, telur dadar gulung, "
        "dan juga jeli. Kami makan di atas rumput bersama keluarga.",
        [
            ("運動会の日のお弁当はどんなお弁当ですか。", ["みんなで食べる特別なお弁当", "いつものお弁当", "小さいお弁当", "冷たいお弁当"], 0),
            ("お弁当に何がありますか。", ["おにぎり、から揚げ、卵焼き、ゼリー", "カレーとサラダ", "パンとスープ", "うどんとてんぷら"], 0),
            ("どこで食べますか。", ["芝生の上", "教室", "体育館", "家"], 0),
        ],
    ),
    (
        "taiikukan_yane_shuuri_oshirase",
        "Pengumuman Perbaikan Atap Gimnasium",
        "来月から一ヶ月間、体育館の屋根を修理します。その間、体育の"
        "授業は校庭でします。雨の日は教室で別の活動をします。",
        "Mulai bulan depan selama satu bulan, atap gimnasium akan "
        "diperbaiki. Selama itu, pelajaran olahraga dilakukan di "
        "lapangan sekolah. Hari hujan, kegiatan lain dilakukan di "
        "kelas.",
        [
            ("何を修理しますか。", ["体育館の屋根", "校庭", "プール", "教室の壁"], 0),
            ("その間、体育の授業はどこでしますか。", ["校庭", "公園", "家", "別の学校"], 0),
            ("雨の日はどうしますか。", ["教室で別の活動をする", "体育館で行う", "休みになる", "外でする"], 0),
        ],
    ),
    (
        "imouto_sewa_tetsudai",
        "Cerita Membantu Menjaga Adik Bayi",
        "今日、母が忙しかったので、赤ちゃんの妹の世話を手伝いました。"
        "ミルクをあげたり、絵本を読んであげたりしました。妹が笑って"
        "くれると、とても幸せな気持ちになります。",
        "Hari ini, karena ibu sibuk, saya membantu menjaga adik bayi "
        "perempuan. Saya memberi susu dan membacakan buku bergambar. "
        "Ketika adik tersenyum, saya merasa sangat bahagia.",
        [
            ("なぜ妹の世話を手伝いましたか。", ["母が忙しかったから", "父が忙しかったから", "妹が泣いていたから", "学校が休みだったから"], 0),
            ("何をしましたか。", ["ミルクをあげたり絵本を読んであげたりした", "一緒に外で遊んだ", "お風呂に入れた", "寝かしつけただけ"], 0),
            ("妹が笑うとどう感じますか。", ["とても幸せな気持ち", "疲れた気持ち", "眠い気持ち", "悲しい気持ち"], 0),
        ],
    ),
    (
        "gasshou_bu_renshuu_jikanwari",
        "Jadwal Latihan Klub Paduan Suara",
        "合唱部の練習は月曜日と水曜日と金曜日の放課後です。場所は"
        "音楽室です。発表会は十二月のクリスマス会にあります。",
        "Latihan klub paduan suara adalah hari Senin, Rabu, dan "
        "Jumat setelah pulang sekolah. Tempatnya di ruang musik. "
        "Pertunjukannya ada di acara Natal bulan Desember.",
        [
            ("練習は何曜日ですか。", ["月曜日と水曜日と金曜日", "火曜日と木曜日", "土曜日だけ", "毎日"], 0),
            ("練習の場所はどこですか。", ["音楽室", "体育館", "校庭", "図書室"], 0),
            ("発表会はいつありますか。", ["十二月のクリスマス会", "三月の卒業式", "四月の入学式", "九月の運動会"], 0),
        ],
    ),
    (
        "ha_kenshin_oshirase",
        "Pengumuman Pemeriksaan Gigi Sekolah",
        "来週、学校で歯の検診があります。順番に歯医者さんに見てもら"
        "います。朝ごはんの後、歯をよく磨いてきてください。",
        "Minggu depan, ada pemeriksaan gigi di sekolah. Kita akan "
        "diperiksa dokter gigi secara bergiliran. Setelah sarapan, "
        "sikat gigi dengan baik.",
        [
            ("いつ歯の検診がありますか。", ["来週", "今週", "来月", "今日"], 0),
            ("誰に見てもらいますか。", ["歯医者さん", "お医者さん", "看護師さん", "先生"], 0),
            ("何をしてきますか。", ["朝ごはんの後、歯をよく磨く", "何も食べない", "早く寝る", "水を飲まない"], 0),
        ],
    ),
    (
        "shinkyuu_oiwai_tegami",
        "Surat Ucapan Selamat Naik Kelas",
        "進級おめでとう。この一年、たくさん成長したね。新しいクラス"
        "でも、きっと楽しい毎日が待っていると思います。これからも"
        "応援しています。",
        "Selamat naik kelas. Setahun ini, kamu banyak berkembang ya. "
        "Di kelas baru pun, pasti hari-hari yang menyenangkan "
        "menanti. Mulai sekarang pun saya akan terus mendukung.",
        [
            ("何をお祝いしていますか。", ["進級", "卒業", "誕生日", "入学"], 0),
            ("この一年についてどう言っていますか。", ["たくさん成長した", "何も変わらなかった", "大変だった", "つまらなかった"], 0),
            ("新しいクラスについて何と言っていますか。", ["きっと楽しい毎日が待っている", "難しいだけだ", "心配だけだ", "何もない"], 0),
        ],
    ),
    (
        "sofu_tsuri_hanashi",
        "Cerita Memancing bersama Kakek",
        "日曜日、祖父と一緒に川へ釣りに行きました。初めて自分で魚を"
        "釣ることができました。祖父はとても喜んで、写真をたくさん"
        "撮ってくれました。",
        "Hari Minggu, saya pergi memancing ke sungai bersama kakek. "
        "Untuk pertama kalinya saya bisa memancing ikan sendiri. "
        "Kakek sangat senang, dan mengambil banyak foto.",
        [
            ("誰と釣りに行きましたか。", ["祖父", "父", "兄", "友達"], 0),
            ("何を初めてできましたか。", ["自分で魚を釣ること", "泳ぐこと", "船を運転すること", "料理すること"], 0),
            ("祖父はどうしましたか。", ["とても喜んで写真をたくさん撮った", "何も言わなかった", "怒った", "眠ってしまった"], 0),
        ],
    ),
    (
        "idou_toshokan_oshirase",
        "Pengumuman Perpustakaan Keliling",
        "来月から、移動図書館の車が学校に来ます。月に一度、いろいろ"
        "な本を持ってきてくれます。休み時間に本を借りたり返したり"
        "できます。",
        "Mulai bulan depan, mobil perpustakaan keliling akan datang "
        "ke sekolah. Sebulan sekali, membawa berbagai buku. Saat "
        "istirahat bisa meminjam dan mengembalikan buku.",
        [
            ("来月から何が学校に来ますか。", ["移動図書館の車", "移動動物園", "移動売店", "移動プール"], 0),
            ("どのくらいの頻度で来ますか。", ["月に一度", "毎日", "週に一度", "年に一度"], 0),
            ("いつ本を借りたり返したりできますか。", ["休み時間", "授業中", "放課後だけ", "朝だけ"], 0),
        ],
    ),
]
...
N4_ENTRIES = [
    ...
    (
        ...
        "最近、手話を習い始めた。聴覚に障害がある友達ができたことが"
        "きっかけだ。最初は簡単なあいさつしかできなかったが、少しず"
        "つ会話ができるようになってきた。もっと多くの人と手話で"
        "コミュニケーションが取れたらいいと思う。",
        "Belakangan ini, saya mulai belajar bahasa isyarat. Pemicunya "
        "adalah mendapat teman yang memiliki gangguan pendengaran. "
        "Awalnya hanya bisa salam sederhana, tapi sedikit demi sedikit "
        "sudah bisa berbicara. Saya berharap bisa berkomunikasi dengan "
        "lebih banyak orang lewat bahasa isyarat.",
        [
            ("何をきっかけに手話を習い始めましたか。", ["聴覚に障害がある友達ができたこと", "学校の授業", "テレビ番組", "仕事のため"], 0),
            ("最初はどんな手話しかできませんでしたか。", ["簡単なあいさつ", "長い会話", "歌", "詩"], 0),
            ("筆者は何を望んでいますか。", ["もっと多くの人と手話でコミュニケーションが取れること", "手話をやめること", "一人で過ごすこと", "日本語だけ話すこと"], 0),
        ],
    ),
    (
        "nikki_shuukan_kouka_kiji",
        "Artikel tentang Manfaat Menulis Jurnal",
        "毎日少しでも日記を書く習慣には、心を落ち着かせる効果がある"
        "と言われている。一日の出来事を振り返ることで、自分の気持ち"
        "を整理しやすくなるそうだ。難しく考えず、短い文でも続ける"
        "ことが大切だという。",
        "Kebiasaan menulis jurnal setiap hari meski sedikit dikatakan "
        "memiliki efek menenangkan hati. Katanya dengan merefleksikan "
        "kejadian sehari, menjadi lebih mudah menata perasaan sendiri. "
        "Katanya penting untuk melanjutkannya meski dengan kalimat "
        "pendek, tanpa berpikir terlalu sulit.",
        [
            ("日記を書く習慣にはどんな効果がありますか。", ["心を落ち着かせる効果", "お金が増える効果", "体力がつく効果", "友達が増える効果"], 0),
            ("一日の出来事を振り返ることで何がしやすくなりますか。", ["自分の気持ちを整理すること", "早く寝ること", "勉強すること", "運動すること"], 0),
            ("何が大切だと言っていますか。", ["短い文でも続けること", "長い文を書くこと", "毎日三時間書くこと", "完璧に書くこと"], 0),
        ],
    ),
    (
        "kouza_jouhou_toiawase_mail",
        "Email Permintaan Informasi Kursus",
        "担当者様。貴校の日本語コースについて、お伺いしたいことが"
        "あります。初級クラスの開始日と授業料について、詳しく教えて"
        "いただけますでしょうか。お忙しいところ恐縮ですが、よろしく"
        "お願いいたします。",
        "Kepada penanggung jawab. Saya ingin bertanya tentang kursus "
        "bahasa Jepang di sekolah Anda. Bisakah dijelaskan secara "
        "detail tentang tanggal mulai kelas pemula dan biaya "
        "kuliahnya? Mohon maaf mengganggu di tengah kesibukan, mohon "
        "bantuannya.",
        [
            ("何について聞きたいですか。", ["日本語コースの開始日と授業料", "先生の名前", "学校の場所だけ", "休みの日"], 0),
            ("どのクラスについて聞いていますか。", ["初級クラス", "上級クラス", "中級クラス", "全てのクラス"], 0),
            ("このメールはどんな文章ですか。", ["情報を求める丁寧な依頼", "苦情", "お礼の手紙", "招待状"], 0),
        ],
    ),
    (
        "shinsetsu_honya_report",
        "Ulasan Toko Buku Baru",
        "先月オープンした本屋に行ってみた。店内にはカフェスペースが"
        "あり、コーヒーを飲みながら本を選べる。品揃えも豊富で、探し"
        "ていた本もすぐに見つかった。また訪れたい場所になった。",
        "Saya mencoba pergi ke toko buku yang baru buka bulan lalu. Di "
        "dalam toko ada ruang kafe, jadi bisa memilih buku sambil "
        "minum kopi. Koleksinya juga banyak, dan buku yang saya cari "
        "juga langsung ditemukan. Ini jadi tempat yang ingin saya "
        "kunjungi lagi.",
        [
            ("店内には何がありますか。", ["カフェスペース", "映画館", "ゲームコーナー", "レストラン"], 0),
            ("品揃えはどうでしたか。", ["豊富だった", "少なかった", "なかった", "高かった"], 0),
            ("筆者はこの本屋についてどう思っていますか。", ["また訪れたい", "二度と行かない", "つまらない", "遠い"], 0),
        ],
    ),
    (
        "jitensha_teire_guide",
        "Panduan Merawat Sepeda",
        "自転車を長く使うためには、定期的な手入れが欠かせない。タイ"
        "ヤの空気は月に一度確認しよう。チェーンに油をさすことも忘れ"
        "ずに行うと、動きがスムーズになる。",
        "Untuk menggunakan sepeda dalam jangka panjang, perawatan "
        "rutin tidak bisa dihindari. Mari cek udara ban sebulan "
        "sekali. Jangan lupa juga memberi minyak pada rantai, agar "
        "gerakannya menjadi lancar.",
        [
            ("自転車を長く使うために何が欠かせませんか。", ["定期的な手入れ", "高いお金", "新しいタイヤ", "毎日乗ること"], 0),
            ("タイヤの空気はどのくらいの頻度で確認しますか。", ["月に一度", "毎日", "一年に一度", "週に三回"], 0),
            ("チェーンに油をさすとどうなりますか。", ["動きがスムーズになる", "壊れる", "重くなる", "音が大きくなる"], 0),
        ],
    ),
    (
        "kekkon_oiwai_tegami",
        "Surat Ucapan Selamat Pernikahan",
        "ご結婚おめでとうございます。お二人の幸せそうな笑顔を見て、"
        "私までうれしくなりました。これからも仲良く、支え合って歩ん"
        "でいってください。末永くお幸せに。",
        "Selamat atas pernikahannya. Melihat senyum bahagia kalian "
        "berdua, saya pun jadi ikut senang. Mulai sekarang pun, "
        "tetaplah akur dan saling mendukung dalam menjalani hidup. "
        "Semoga bahagia selamanya.",
        [
            ("何をお祝いしていますか。", ["結婚", "誕生日", "卒業", "就職"], 0),
            ("お二人の笑顔を見て、筆者はどう感じましたか。", ["うれしくなった", "悲しくなった", "驚いた", "怒った"], 0),
            ("筆者は何を願っていますか。", ["仲良く支え合って歩んでいくこと", "早く別れること", "お金持ちになること", "有名になること"], 0),
        ],
    ),
    (
        "asa_stretch_kouka_kiji",
        "Artikel tentang Manfaat Peregangan Pagi",
        "朝起きてすぐにストレッチをすると、体が目覚めやすくなると"
        "言われている。血の流れが良くなり、一日を活動的に過ごせる"
        "そうだ。五分程度の簡単なストレッチでも十分効果があるという。",
        "Katanya jika melakukan peregangan segera setelah bangun pagi, "
        "tubuh menjadi lebih mudah terbangun. Aliran darah menjadi "
        "lebih baik, sehingga bisa menjalani hari dengan aktif. "
        "Katanya peregangan sederhana sekitar lima menit pun sudah "
        "cukup efektif.",
        [
            ("朝起きてすぐにストレッチをするとどうなりますか。", ["体が目覚めやすくなる", "もっと眠くなる", "疲れる", "体が痛くなる"], 0),
            ("血の流れが良くなると何ができますか。", ["一日を活動的に過ごせる", "すぐに眠れる", "食欲がなくなる", "痩せる"], 0),
            ("どのくらいのストレッチで十分効果がありますか。", ["五分程度", "一時間", "三十分", "十秒"], 0),
        ],
    ),
    (
        "volunteer_hajimete_taiken",
        "Pengalaman Menjadi Sukarelawan Pertama Kali",
        "先週、初めて地域の清掃ボランティアに参加した。最初は少し"
        "緊張したが、参加者同士で声をかけ合いながら作業した。終わっ"
        "た後、街がきれいになったのを見て、達成感を感じた。",
        "Minggu lalu, saya untuk pertama kalinya mengikuti sukarelawan "
        "kebersihan daerah. Awalnya sedikit gugup, tapi saling "
        "menyapa sesama peserta sambil bekerja. Setelah selesai, "
        "melihat kota menjadi bersih, saya merasa puas.",
        [
            ("先週、初めて何に参加しましたか。", ["地域の清掃ボランティア", "スポーツ大会", "料理教室", "音楽会"], 0),
            ("最初はどう感じましたか。", ["少し緊張した", "とても楽しかった", "眠かった", "怒っていた"], 0),
            ("終わった後、何を感じましたか。", ["達成感", "後悔", "疲れだけ", "悲しみ"], 0),
        ],
    ),
    (
        "amimono_manabu_burogu",
        "Blog tentang Belajar Merajut",
        "冬になり、編み物を始めてみることにした。最初はうまく編めず、"
        "何度もやり直した。しかし、少しずつコツをつかんで、簡単な"
        "マフラーが作れるようになった。次は手袋に挑戦してみたい。",
        "Karena musim dingin tiba, saya mencoba memulai merajut. "
        "Awalnya tidak bisa merajut dengan baik, dan berkali-kali "
        "mengulang. Namun, sedikit demi sedikit menguasai triknya, "
        "dan sudah bisa membuat syal sederhana. Selanjutnya saya "
        "ingin mencoba membuat sarung tangan.",
        [
            ("いつ編み物を始めましたか。", ["冬になって", "夏になって", "春になって", "秋になって"], 0),
            ("最初はどうでしたか。", ["うまく編めず何度もやり直した", "すぐに上手になった", "簡単だった", "楽しくなかった"], 0),
            ("次は何に挑戦したいですか。", ["手袋", "帽子", "靴下", "セーター"], 0),
        ],
    ),
    (
        "mise_eigyou_jikan_henkou",
        "Pengumuman Perubahan Jam Operasional Toko",
        "来月から、当店の営業時間が変更になります。これまで午後八時"
        "までだった閉店時間が、午後七時になります。お客様にはご不便"
        "をおかけしますが、ご理解いただけますようお願いいたします。",
        "Mulai bulan depan, jam operasional toko kami akan berubah. "
        "Jam tutup yang sampai sekarang jam 8 malam, akan menjadi "
        "jam 7 malam. Kami mohon pengertiannya meskipun akan "
        "merepotkan para pelanggan.",
        [
            ("何が変更になりますか。", ["閉店時間", "開店時間", "定休日", "場所"], 0),
            ("新しい閉店時間は何時ですか。", ["午後七時", "午後八時", "午後六時", "午後九時"], 0),
            ("お客様に何をお願いしていますか。", ["ご理解", "お金", "予約", "早めの来店"], 0),
        ],
    ),
    (
        "kougei_shumi_burogu",
        "Blog tentang Belajar Membuat Kerajinan Tangan",
        "最近、手作りのアクセサリーを作る趣味を始めた。材料を選ぶ"
        "ところから楽しく、時間を忘れて没頭してしまう。友人にプレゼ"
        "ントすると、とても喜んでもらえた。次は何を作ろうか、今から"
        "考えている。",
        "Belakangan ini, saya mulai hobi membuat aksesori buatan "
        "tangan. Sejak memilih bahan pun sudah menyenangkan, sampai "
        "lupa waktu karena tenggelam di dalamnya. Ketika dihadiahkan "
        "ke teman, sangat disukai. Sudah mulai memikirkan apa yang "
        "akan dibuat selanjutnya.",
        [
            ("筆者は最近何の趣味を始めましたか。", ["手作りのアクセサリー", "料理", "写真", "音楽"], 0),
            ("何をするところから楽しいですか。", ["材料を選ぶこと", "お金を払うこと", "片付けること", "説明書を読むこと"], 0),
            ("友人にプレゼントするとどうでしたか。", ["とても喜んでもらえた", "あまり喜ばれなかった", "断られた", "何も言われなかった"], 0),
        ],
    ),
    (
        "ongaku_kouka_kiji",
        "Artikel tentang Manfaat Mendengarkan Musik",
        "好きな音楽を聴くと、ストレスが軽くなると言われている。特に、"
        "作業をしながら聴く音楽は、集中力を高める効果もあるそうだ。"
        "自分に合った音楽を見つけることが、日常生活を豊かにする一つ"
        "の方法だという。",
        "Katanya jika mendengarkan musik yang disukai, stres menjadi "
        "ringan. Terutama, musik yang didengarkan sambil bekerja "
        "katanya juga punya efek meningkatkan konsentrasi. Katanya "
        "menemukan musik yang cocok untuk diri sendiri adalah salah "
        "satu cara memperkaya kehidupan sehari-hari.",
        [
            ("好きな音楽を聴くとどうなると言われていますか。", ["ストレスが軽くなる", "もっと疲れる", "眠くなる", "何も変わらない"], 0),
            ("作業をしながら聴く音楽にはどんな効果がありますか。", ["集中力を高める効果", "眠くなる効果", "忘れっぽくなる効果", "不安になる効果"], 0),
            ("何が日常生活を豊かにする方法だと言っていますか。", ["自分に合った音楽を見つけること", "高い機材を買うこと", "有名な曲だけ聴くこと", "音楽をやめること"], 0),
        ],
    ),
    (
        "apaato_keiyaku_koushin_mail",
        "Email Permintaan Perpanjangan Sewa Apartemen",
        "管理人様。お世話になっております。現在の部屋の契約期間が"
        "もうすぐ終わりますので、契約を更新したいと思っております。"
        "手続きについて教えていただけますでしょうか。よろしくお願い"
        "いたします。",
        "Kepada pengelola. Terima kasih atas bantuannya selama ini. "
        "Karena masa kontrak kamar saat ini akan segera berakhir, "
        "saya ingin memperbarui kontrak. Bisakah dijelaskan tentang "
        "prosedurnya? Mohon bantuannya.",
        [
            ("何がもうすぐ終わりますか。", ["現在の部屋の契約期間", "家賃の支払い期限", "引っ越しの予定", "電気の契約"], 0),
            ("何をしたいと思っていますか。", ["契約を更新すること", "引っ越すこと", "契約を終了すること", "部屋を変えること"], 0),
            ("何について教えてほしいですか。", ["手続き", "家賃の値段", "部屋の広さ", "近所の店"], 0),
        ],
    ),
    (
        "online_shopping_app_report",
        "Ulasan Aplikasi Belanja Online",
        "最近使い始めたオンラインショッピングのアプリは、とても使い"
        "やすい。商品の検索が簡単で、レビューも参考になる。配送も"
        "早く、今のところ大きな不満はない。ただ、返品の手続きが少し"
        "複雑だと感じた。",
        "Aplikasi belanja online yang baru-baru ini saya mulai "
        "gunakan, sangat mudah digunakan. Pencarian produk mudah, "
        "dan ulasannya juga membantu. Pengirimannya juga cepat, "
        "sejauh ini tidak ada ketidakpuasan besar. Hanya saja, "
        "prosedur pengembalian barang terasa sedikit rumit.",
        [
            ("このアプリはどんなアプリですか。", ["とても使いやすい", "とても使いにくい", "高すぎる", "古い"], 0),
            ("配送についてどう感じていますか。", ["早い", "遅い", "不安定", "高い"], 0),
            ("何が少し複雑だと感じましたか。", ["返品の手続き", "商品の検索", "レビューの投稿", "支払い方法"], 0),
        ],
    ),
    (
        "neko_kau_guide",
        "Panduan Merawat Kucing Peliharaan",
        "猫を飼い始めたら、まず快適な環境を整えることが大切だ。トイ"
        "レはいつも清潔にしておこう。食事の量にも気を配り、太りすぎ"
        "ないように注意することも忘れてはいけない。",
        "Jika mulai memelihara kucing, pertama-tama penting untuk "
        "menyiapkan lingkungan yang nyaman. Mari selalu menjaga "
        "toilet tetap bersih. Jangan lupa juga memperhatikan jumlah "
        "makanan, dan berhati-hati agar tidak terlalu gemuk.",
        [
            ("猫を飼い始めたら、まず何が大切ですか。", ["快適な環境を整えること", "高いおもちゃを買うこと", "毎日散歩させること", "名前をつけること"], 0),
            ("トイレはどうしておきますか。", ["いつも清潔にしておく", "たまに掃除する", "掃除しなくていい", "猫が自分で掃除する"], 0),
            ("何に気を配りますか。", ["食事の量", "毛の色", "鳴き声", "目の色"], 0),
        ],
    ),
    (
        "shussan_oiwai_tegami",
        "Surat Ucapan Selamat Kelahiran Anak",
        "ご出産おめでとうございます。元気な赤ちゃんが生まれたと聞い"
        "て、とてもうれしいです。しばらくは大変だと思いますが、無理"
        "をせずゆっくり休んでください。落ち着いたら、ぜひ会いに行か"
        "せてください。",
        "Selamat atas kelahirannya. Sangat senang mendengar bayi yang "
        "sehat telah lahir. Kupikir sementara ini akan berat, tapi "
        "tolong istirahat yang cukup tanpa memaksakan diri. Kalau "
        "sudah lebih tenang, izinkan saya berkunjung ya.",
        [
            ("何をお祝いしていますか。", ["出産", "結婚", "誕生日", "卒業"], 0),
            ("何を聞いてうれしいと言っていますか。", ["元気な赤ちゃんが生まれたこと", "結婚したこと", "昇進したこと", "引っ越したこと"], 0),
            ("何をお願いしていますか。", ["無理をせずゆっくり休むこと", "すぐに働くこと", "早く会うこと", "返事をすること"], 0),
        ],
    ),
    (
        "mizu_kenkou_kouka_kiji",
        "Artikel tentang Manfaat Minum Air Putih",
        "一日に必要な水分を十分に取ることは、体調管理の基本だと言わ"
        "れている。水分が不足すると、集中力の低下や疲労感につながる"
        "こともあるそうだ。こまめに少しずつ水を飲む習慣をつけること"
        "が勧められている。",
        "Katanya minum cukup cairan yang dibutuhkan sehari adalah "
        "dasar dari pengelolaan kondisi tubuh. Katanya jika "
        "kekurangan cairan, bisa menyebabkan penurunan konsentrasi "
        "dan rasa lelah. Dianjurkan membiasakan minum air sedikit "
        "demi sedikit secara rutin.",
        [
            ("一日に必要な水分を十分に取ることは何の基本ですか。", ["体調管理", "勉強", "運動", "料理"], 0),
            ("水分が不足するとどうなることがありますか。", ["集中力の低下や疲労感", "体重の増加だけ", "眠気だけ", "元気になること"], 0),
            ("どんな習慣が勧められていますか。", ["こまめに少しずつ水を飲む習慣", "一度にたくさん飲む習慣", "水を飲まない習慣", "冷たい水だけ飲む習慣"], 0),
        ],
    ),
    (
        "kyoushi_hajimete_taiken",
        "Pengalaman Pertama Kali Mengajar",
        "先週、初めて子供たちに勉強を教える機会があった。うまく説明"
        "できるか不安だったが、子供たちが「分かった!」と言ってくれ"
        "たときは本当にうれしかった。教えることの楽しさを、初めて"
        "実感した。",
        "Minggu lalu, saya mendapat kesempatan untuk pertama kalinya "
        "mengajar anak-anak belajar. Khawatir apakah bisa menjelaskan "
        "dengan baik, tapi ketika anak-anak berkata \"mengerti!\" "
        "saya benar-benar senang. Untuk pertama kalinya merasakan "
        "kesenangan mengajar.",
        [
            ("先週、初めて何をする機会がありましたか。", ["子供たちに勉強を教えること", "子供たちと遊ぶこと", "子供たちの世話をすること", "子供たちに料理を教えること"], 0),
            ("最初、筆者はどう感じていましたか。", ["うまく説明できるか不安だった", "とても自信があった", "楽しみだけだった", "興味がなかった"], 0),
            ("何を初めて実感しましたか。", ["教えることの楽しさ", "教えることの難しさだけ", "子供の大変さ", "勉強の重要性だけ"], 0),
        ],
    ),
    (
        "kankokugo_manabu_burogu",
        "Blog tentang Belajar Bahasa Korea",
        "韓国のドラマが好きになったことがきっかけで、韓国語を勉強し"
        "始めた。文字を覚えるのは大変だったが、少しずつ簡単な会話が"
        "分かるようになってきた。いつか字幕なしでドラマを見られる"
        "ようになりたい。",
        "Karena menjadi suka drama Korea sebagai pemicunya, saya "
        "mulai belajar bahasa Korea. Menghafal huruf itu berat, tapi "
        "sedikit demi sedikit mulai bisa memahami percakapan "
        "sederhana. Suatu saat ingin bisa menonton drama tanpa "
        "subtitle.",
        [
            ("何がきっかけで韓国語を勉強し始めましたか。", ["韓国のドラマが好きになったこと", "仕事のため", "学校の授業", "友達に誘われたこと"], 0),
            ("何が大変でしたか。", ["文字を覚えること", "発音すること", "書くこと", "聞くこと"], 0),
            ("将来どうなりたいと思っていますか。", ["字幕なしでドラマを見られるようになりたい", "韓国に住みたい", "韓国語の先生になりたい", "ドラマをやめたい"], 0),
        ],
    ),
    (
        "mise_shiharai_system_henkou",
        "Pengumuman Perubahan Sistem Pembayaran Toko",
        "来月から、当店ではキャッシュレス決済のみのご利用となります。"
        "現金でのお支払いはできなくなりますので、あらかじめご了承"
        "ください。ご不明な点は、店員までお尋ねください。",
        "Mulai bulan depan, toko kami hanya menerima pembayaran "
        "non-tunai. Pembayaran dengan uang tunai tidak bisa lagi "
        "dilakukan, mohon dimaklumi sebelumnya. Jika ada yang kurang "
        "jelas, silakan tanyakan ke pelayan.",
        [
            ("来月から何のみの利用になりますか。", ["キャッシュレス決済", "現金決済", "クレジットカードだけ", "何でも使える"], 0),
            ("現金でのお支払いはどうなりますか。", ["できなくなる", "そのまま使える", "割引される", "時々使える"], 0),
            ("不明な点はどうすればいいですか。", ["店員に尋ねる", "電話する", "ホームページを見る", "何もしない"], 0),
        ],
    ),
    (
        "pan_tsukuru_manabu_burogu",
        "Blog tentang Belajar Membuat Roti",
        "最近、家でパンを作る趣味を始めた。発酵の時間を待つのは大変"
        "だが、焼き上がったときの香りは格別だ。まだ形が不格好なこと"
        "もあるが、少しずつ上達している実感がある。",
        "Belakangan ini, saya mulai hobi membuat roti di rumah. "
        "Menunggu waktu fermentasi itu berat, tapi aroma saat matang "
        "itu istimewa. Terkadang bentuknya masih tidak rapi, tapi "
        "ada rasa sedikit demi sedikit menjadi lebih mahir.",
        [
            ("筆者は最近何の趣味を始めましたか。", ["家でパンを作ること", "ケーキを作ること", "料理教室に通うこと", "レストランで働くこと"], 0),
            ("何が大変ですか。", ["発酵の時間を待つこと", "材料を買うこと", "オーブンを使うこと", "レシピを読むこと"], 0),
            ("焼き上がったときの何が格別ですか。", ["香り", "形", "値段", "色"], 0),
        ],
    ),
    (
        "uekiuebachi_kouka_kiji",
        "Artikel tentang Manfaat Menanam Tanaman di Rumah",
        "室内に植物を置くと、リラックス効果があると言われている。"
        "植物の世話をする時間そのものが、忙しい日常の中で心を落ち"
        "着かせる貴重なひとときになるそうだ。",
        "Katanya jika meletakkan tanaman di dalam ruangan, ada efek "
        "relaksasi. Katanya waktu untuk merawat tanaman itu sendiri "
        "menjadi momen berharga yang menenangkan hati di tengah "
        "kesibukan sehari-hari.",
        [
            ("室内に植物を置くとどんな効果があると言われていますか。", ["リラックス効果", "集中力低下の効果", "眠気の効果", "食欲増進の効果"], 0),
            ("何が心を落ち着かせる貴重なひとときになりますか。", ["植物の世話をする時間そのもの", "植物を買う時間", "植物を見るだけの時間", "何もない時間"], 0),
            ("いつこのひとときが貴重ですか。", ["忙しい日常の中で", "暇なとき", "休日だけ", "夜だけ"], 0),
        ],
    ),
    (
        "mensetsu_yotei_toiawase_mail",
        "Email Permintaan Jadwal Wawancara Kerja",
        "採用ご担当者様。この度は書類選考を通過させていただき、あり"
        "がとうございます。面接の日程について、ご都合の良い日時を"
        "教えていただけますでしょうか。よろしくお願いいたします。",
        "Kepada penanggung jawab rekrutmen. Terima kasih telah "
        "meloloskan seleksi dokumen kali ini. Mengenai jadwal "
        "wawancara, bisakah diberitahukan tanggal dan waktu yang "
        "sesuai? Mohon bantuannya.",
        [
            ("このメールは何について書いていますか。", ["面接の日程", "給料の相談", "会社の場所", "入社日"], 0),
            ("何に感謝していますか。", ["書類選考を通過させてもらったこと", "面接を受けたこと", "内定をもらったこと", "会社に入れたこと"], 0),
            ("何を教えてほしいとお願いしていますか。", ["ご都合の良い日時", "面接の内容", "給料", "会社の歴史"], 0),
        ],
    ),
    (
        "gym_shinsetsu_report",
        "Ulasan Gym Baru di Dekat Rumah",
        "家の近くに新しくできたジムに通い始めた。マシンの種類が豊富"
        "で、スタッフも丁寧に教えてくれる。料金は少し高めだが、通い"
        "やすい場所にあるので続けやすいと感じている。",
        "Saya mulai pergi ke gym baru yang dibuka dekat rumah. Jenis "
        "mesinnya beragam, dan staf juga mengajari dengan teliti. "
        "Harganya sedikit lebih mahal, tapi karena lokasinya mudah "
        "dijangkau, terasa mudah untuk melanjutkannya.",
        [
            ("どこに新しいジムができましたか。", ["家の近く", "会社の近く", "駅の近くだけ", "学校の近く"], 0),
            ("スタッフはどうですか。", ["丁寧に教えてくれる", "冷たい", "何も教えてくれない", "忙しそう"], 0),
            ("料金についてどう感じていますか。", ["少し高め", "とても安い", "ちょうどいい", "分からない"], 0),
        ],
    ),
    (
        "kawagutsu_teire_guide",
        "Panduan Merawat Sepatu Kulit",
        "革靴を長持ちさせるには、履いた後にブラシでほこりを落とす"
        "ことが大切だ。定期的にクリームを塗って、革に栄養を与える"
        "ことも忘れないようにしよう。雨の日はできるだけ履かないほう"
        "がいい。",
        "Untuk membuat sepatu kulit tahan lama, penting untuk "
        "membersihkan debu dengan sikat setelah dipakai. Jangan lupa "
        "juga secara rutin mengoleskan krim untuk memberi nutrisi "
        "pada kulit. Sebaiknya sebisa mungkin tidak dipakai saat "
        "hujan.",
        [
            ("革靴を長持ちさせるには何が大切ですか。", ["履いた後にブラシでほこりを落とすこと", "毎日洗うこと", "高い靴を買うこと", "履かないこと"], 0),
            ("定期的に何をすることを忘れないようにしますか。", ["クリームを塗ること", "磨くことだけ", "乾かすことだけ", "色を変えること"], 0),
            ("雨の日はどうしたほうがいいですか。", ["できるだけ履かない", "たくさん履く", "洗ってから履く", "気にしない"], 0),
        ],
    ),
    (
        "teinen_oiwai_tegami",
        "Surat Ucapan Selamat Pensiun",
        "ご定年、誠におめでとうございます。長い間、本当にお疲れ様で"
        "した。これからは、ご自身の時間を大切に、趣味や旅行を楽しん"
        "でください。今後のご健康とご多幸をお祈りしております。",
        "Selamat atas pensiunnya. Selama bertahun-tahun, benar-benar "
        "terima kasih atas kerja kerasnya. Mulai sekarang, mohon "
        "jaga waktu untuk diri sendiri, nikmati hobi dan perjalanan. "
        "Saya mendoakan kesehatan dan kebahagiaan ke depannya.",
        [
            ("何をお祝いしていますか。", ["定年", "昇進", "結婚", "出産"], 0),
            ("これからどうしてほしいと言っていますか。", ["自身の時間を大切に趣味や旅行を楽しむこと", "すぐに新しい仕事を探すこと", "家にずっといること", "働き続けること"], 0),
            ("何を祈っていますか。", ["今後の健康と多幸", "仕事の成功だけ", "お金持ちになること", "有名になること"], 0),
        ],
    ),
    (
        "hirune_kouka_kiji",
        "Artikel tentang Manfaat Tidur Siang",
        "短い昼寝には、午後の集中力を回復させる効果があると言われて"
        "いる。ただし、長く寝すぎると夜の睡眠に影響が出ることもある"
        "ため、二十分程度にとどめるのがいいそうだ。",
        "Katanya tidur siang singkat punya efek memulihkan "
        "konsentrasi di sore hari. Namun, karena jika tidur terlalu "
        "lama bisa mempengaruhi tidur malam, katanya sebaiknya "
        "dibatasi sekitar dua puluh menit.",
        [
            ("短い昼寝にはどんな効果があると言われていますか。", ["午後の集中力を回復させる効果", "夜眠れなくなる効果", "食欲が増す効果", "体重が増える効果"], 0),
            ("長く寝すぎるとどうなることがありますか。", ["夜の睡眠に影響が出る", "もっと元気になる", "何も変わらない", "集中力が上がる"], 0),
            ("昼寝はどのくらいがいいと言われていますか。", ["二十分程度", "二時間程度", "五分程度", "一時間程度"], 0),
        ],
    ),
    (
        "unten_hajimete_taiken",
        "Pengalaman Pertama Kali Menyetir Sendiri",
        "先週末、免許を取ってから初めて一人で車を運転した。緊張して"
        "手が震えたが、無事に目的地まで着くことができた。自分で運転"
        "できる自由さを、初めて実感した瞬間だった。",
        "Akhir pekan lalu, untuk pertama kalinya setelah dapat SIM, "
        "saya menyetir sendiri. Tangan gemetar karena tegang, tapi "
        "bisa sampai tujuan dengan selamat. Momen pertama kali "
        "merasakan kebebasan bisa menyetir sendiri.",
        [
            ("いつ初めて一人で運転しましたか。", ["先週末", "昨日", "今日", "来週"], 0),
            ("運転中どうでしたか。", ["緊張して手が震えた", "とてもリラックスしていた", "眠かった", "楽しいだけだった"], 0),
            ("何を初めて実感しましたか。", ["自分で運転できる自由さ", "運転の難しさだけ", "車の高さ", "道路の混雑"], 0),
        ],
    ),
    (
        "video_tsukuru_manabu_burogu",
        "Blog tentang Belajar Membuat Video",
        "動画編集に興味を持ち、独学で勉強を始めた。最初は簡単な操作"
        "も分からなかったが、無料の講座を見ながら練習するうちに、"
        "短い動画なら作れるようになった。",
        "Tertarik dengan editing video, saya mulai belajar secara "
        "otodidak. Awalnya operasi sederhana pun tidak paham, tapi "
        "seiring berlatih sambil menonton kursus gratis, sudah bisa "
        "membuat video pendek.",
        [
            ("何に興味を持ちましたか。", ["動画編集", "写真撮影", "音楽制作", "デザイン"], 0),
            ("どうやって勉強していますか。", ["独学で", "学校で", "会社の研修で", "友達に教えてもらって"], 0),
            ("今、何ができるようになりましたか。", ["短い動画を作ること", "長い映画を作ること", "何もできない", "プロになること"], 0),
        ],
    ),
    (
        "office_ichi_henkou_oshirase",
        "Pengumuman Perubahan Lokasi Kantor",
        "来月一日から、本社事務所が新しい場所に移転します。最寄り駅"
        "は変わりますので、ご注意ください。詳しい地図は後日メールで"
        "お送りします。",
        "Mulai tanggal satu bulan depan, kantor pusat akan pindah "
        "ke lokasi baru. Stasiun terdekat akan berubah, mohon "
        "diperhatikan. Peta detail akan dikirim lewat email di "
        "kemudian hari.",
        [
            ("いつ事務所が移転しますか。", ["来月一日から", "今月末から", "来週から", "来年から"], 0),
            ("何が変わりますか。", ["最寄り駅", "電話番号", "社員の人数", "会社名"], 0),
            ("詳しい地図はどうやって届きますか。", ["後日メールで", "郵便で", "電話で", "直接手渡しで"], 0),
        ],
    ),
]
...
N3_ENTRIES = [
    ...
    (
        ...
        "電気自動車の普及が進む中、充電設備の整備が追いついていない"
        "地域も多い。環境への負荷を減らすという目的は理解されつつ"
        "あるものの、実際に導入するには課題も少なくないわけだ。",
        "Di tengah meluasnya kendaraan listrik, banyak daerah di mana "
        "fasilitas pengisian daya belum sesuai. Meskipun tujuan "
        "mengurangi beban lingkungan mulai dipahami, kenyataannya "
        "untuk benar-benar mengadopsinya juga tidak sedikit "
        "tantangannya.",
        [
            ("電気自動車の普及が進む中、何が追いついていませんか。", ["充電設備の整備", "道路の整備", "人口の増加", "経済成長"], 0),
            ("電気自動車の目的は何ですか。", ["環境への負荷を減らすこと", "お金を稼ぐこと", "速く走ること", "デザインを良くすること"], 0),
            ("実際に導入するにはどうですか。", ["課題も少なくない", "全く問題がない", "簡単である", "誰でもできる"], 0),
        ],
    ),
    (
        "tomodachi_wakare_essay",
        "Esai tentang Menghadapi Perpisahan dengan Teman",
        "親しい友人が転勤で遠くへ引っ越すことになった。寂しさは隠せ"
        "ないが、新しい環境での活躍を願わずにはいられない。物理的な"
        "距離があっても、心の距離は変わらないと信じている。",
        "Teman dekat harus pindah jauh karena mutasi kerja. Kesedihan "
        "tidak bisa disembunyikan, tetapi saya tidak bisa menahan diri "
        "untuk berharap kesuksesannya di lingkungan baru. Saya "
        "percaya meski ada jarak fisik, jarak hati tidak akan "
        "berubah.",
        [
            ("親しい友人はなぜ引っ越すことになりましたか。", ["転勤", "結婚", "進学", "病気"], 0),
            ("筆者は何を願わずにはいられませんか。", ["友人の新しい環境での活躍", "友人が戻ってくること", "自分も引っ越すこと", "何も願っていない"], 0),
            ("筆者は何を信じていますか。", ["心の距離は変わらないこと", "もう会えないこと", "友情が終わること", "距離が全てだということ"], 0),
        ],
    ),
    (
        "gyouji_iinkai_taiken",
        "Cerita Pengalaman Menjadi Panitia Acara",
        "文化祭の実行委員になり、準備の大変さを実感した。意見がぶつ"
        "かることもあったが、みんなで話し合いながら少しずつ計画を"
        "進めた。本番が成功したときの達成感は、今でも忘れられない。",
        "Menjadi panitia festival budaya, saya benar-benar merasakan "
        "betapa beratnya persiapan. Ada kalanya pendapat bertabrakan, "
        "tapi kami maju dengan rencana sedikit demi sedikit sambil "
        "berdiskusi bersama. Rasa pencapaian ketika hari-H sukses, "
        "sampai sekarang tidak terlupakan.",
        [
            ("何の実行委員になりましたか。", ["文化祭", "運動会", "卒業式", "入学式"], 0),
            ("準備の中で何がありましたか。", ["意見がぶつかること", "何も問題がなかったこと", "誰も参加しなかったこと", "すぐに終わったこと"], 0),
            ("本番が成功したときの気持ちはどうですか。", ["今でも忘れられない達成感", "すぐに忘れた", "がっかりした気持ち", "何も感じなかった"], 0),
        ],
    ),
    (
        "mail_communication_manaa",
        "Panduan Etika Berkomunikasi lewat Email",
        "ビジネスメールでは、絵文字や略語を使わないのが基本だ。件名"
        "は内容が一目で分かるように簡潔に書くことが求められる。返信"
        "はできるだけ早く行うことも、信頼関係を築く上で重要だわけだ。",
        "Dalam email bisnis, tidak menggunakan emoji atau singkatan "
        "adalah dasarnya. Judul email dituntut ditulis secara ringkas "
        "agar isinya bisa dipahami sekali lihat. Membalas secepat "
        "mungkin juga penting dalam membangun hubungan saling "
        "percaya.",
        [
            ("ビジネスメールでは何を使わないのが基本ですか。", ["絵文字や略語", "丁寧な言葉", "件名", "あいさつ"], 0),
            ("件名はどう書くことが求められますか。", ["簡潔に", "長く詳しく", "面白く", "難しく"], 0),
            ("返信について何が重要だと言っていますか。", ["できるだけ早く行うこと", "遅くてもいいこと", "返信しなくてもいいこと", "短くすること"], 0),
        ],
    ),
    (
        "gakusei_parttime_trend_kiji",
        "Artikel tentang Tren Kerja Paruh Waktu bagi Pelajar",
        "学業と両立しながら働く学生が増えている背景には、学費や生活"
        "費の負担がある。無理のない範囲で経験を積むことは、社会に"
        "出る前の良い準備になる一方、勉強がおろそかにならないよう"
        "注意が必要だ。",
        "Di balik meningkatnya pelajar yang bekerja sambil "
        "menyeimbangkan studi, ada beban biaya sekolah dan biaya "
        "hidup. Mengumpulkan pengalaman dalam batas wajar menjadi "
        "persiapan baik sebelum terjun ke masyarakat, di sisi lain "
        "perlu perhatian agar studi tidak terabaikan.",
        [
            ("学業と両立しながら働く学生が増えている背景には何がありますか。", ["学費や生活費の負担", "遊びたい気持ちだけ", "親の命令", "友達の誘い"], 0),
            ("無理のない範囲で経験を積むことは何になりますか。", ["社会に出る前の良い準備", "時間の無駄", "悪い影響だけ", "不要なこと"], 0),
            ("何に注意が必要ですか。", ["勉強がおろそかにならないこと", "働きすぎないこと以外", "友達を作ること", "お金を使わないこと"], 0),
        ],
    ),
    (
        "kyuukei_jikan_taisetsu_essay",
        "Esai tentang Pentingnya Waktu Istirahat",
        "忙しさの中で、休むことに罪悪感を覚える人は少なくない。しか"
        "し、適切な休息を取らなければ、長期的には効率が落ちてしまう"
        "わけだ。頑張り続けることだけが、良い結果につながるとは限ら"
        "ない。",
        "Di tengah kesibukan, tidak sedikit orang yang merasa bersalah "
        "untuk beristirahat. Namun, jika tidak mengambil istirahat "
        "yang cukup, dalam jangka panjang efisiensi akan menurun. "
        "Terus berusaha keras saja belum tentu mengarah ke hasil yang "
        "baik.",
        [
            ("忙しさの中で人々は何を覚えることが少なくありませんか。", ["休むことへの罪悪感", "喜び", "安心感", "満足感"], 0),
            ("適切な休息を取らないとどうなりますか。", ["長期的には効率が落ちる", "すぐに成功する", "何も変わらない", "もっと元気になる"], 0),
            ("筆者は何が良い結果につながるとは限らないと言っていますか。", ["頑張り続けることだけ", "休むことだけ", "何もしないこと", "遊ぶことだけ"], 0),
        ],
    ),
    (
        "visa_shinsei_tetsuzuki",
        "Petunjuk Prosedur Pengajuan Visa",
        "海外に長期滞在する場合、事前にビザを申請する必要がある。"
        "必要書類を大使館に提出し、審査が通れば発給される。書類に"
        "不備があると審査に時間がかかるため、事前の確認が欠かせない。",
        "Jika akan tinggal lama di luar negeri, perlu mengajukan visa "
        "terlebih dahulu. Dokumen yang diperlukan diserahkan ke "
        "kedutaan, dan jika lolos pemeriksaan, akan diterbitkan. "
        "Karena jika dokumen tidak lengkap pemeriksaannya memakan "
        "waktu, pengecekan sebelumnya tidak bisa dihindari.",
        [
            ("海外に長期滞在する場合、何が必要ですか。", ["事前のビザ申請", "航空券だけ", "パスポートだけ", "お金だけ"], 0),
            ("必要書類はどこに提出しますか。", ["大使館", "市役所", "空港", "銀行"], 0),
            ("書類に不備があるとどうなりますか。", ["審査に時間がかかる", "すぐに却下される", "無視される", "何も変わらない"], 0),
        ],
    ),
    (
        "undou_shuukan_henka_kiji",
        "Artikel tentang Perubahan Kebiasaan Berolahraga",
        "ジムに通う代わりに、自宅で動画を見ながら運動する人が増えて"
        "いる。時間や場所を選ばずにできる手軽さが人気の理由だそうだ。"
        "継続のしやすさも、この方法が支持される要因の一つだろう。",
        "Semakin banyak orang yang berolahraga di rumah sambil "
        "menonton video, sebagai pengganti pergi ke gym. Katanya "
        "kepraktisan yang bisa dilakukan tanpa memilih waktu dan "
        "tempat adalah alasan popularitasnya. Kemudahan untuk "
        "melanjutkannya juga mungkin salah satu faktor mengapa metode "
        "ini didukung.",
        [
            ("ジムに通う代わりに何をする人が増えていますか。", ["自宅で動画を見ながら運動すること", "何もしないこと", "毎日走ること", "友達と運動すること"], 0),
            ("この方法が人気の理由は何ですか。", ["時間や場所を選ばない手軽さ", "値段が高いこと", "結果がすぐ出ること", "有名人がやっていること"], 0),
            ("この方法が支持される要因の一つは何ですか。", ["継続のしやすさ", "難しさ", "値段の高さ", "時間がかかること"], 0),
        ],
    ),
    (
        "hatsugen_yuuki_essay",
        "Esai tentang Menemukan Keberanian Berbicara di Depan Umum",
        "人前で話すことが苦手だったが、小さな発表を重ねるうちに、"
        "少しずつ自信を持てるようになった。完璧を目指すのではなく、"
        "伝えたいという気持ちを大切にすることが、緊張を和らげるコツ"
        "だと気づいた。",
        "Saya tidak pandai berbicara di depan orang, tapi seiring "
        "mengulang presentasi kecil, sedikit demi sedikit menjadi "
        "bisa percaya diri. Saya menyadari bahwa bukan menargetkan "
        "kesempurnaan, tapi menghargai perasaan ingin menyampaikan "
        "itulah trik meredakan ketegangan.",
        [
            ("筆者は最初、何が苦手でしたか。", ["人前で話すこと", "書くこと", "計算すること", "歌うこと"], 0),
            ("何を重ねるうちに自信を持てるようになりましたか。", ["小さな発表", "大きな試験", "運動", "読書"], 0),
            ("緊張を和らげるコツは何だと気づきましたか。", ["伝えたいという気持ちを大切にすること", "完璧を目指すこと", "話さないこと", "早口で話すこと"], 0),
        ],
    ),
    (
        "ryou_seikatsu_taiken",
        "Cerita Pengalaman Tinggal di Asrama",
        "大学の寮生活を始めて半年が経った。最初は共同生活のルールに"
        "戸惑ったが、今では仲間と協力しながら快適に過ごせるように"
        "なった。一人では気づけなかったことを、多く学べた気がする。",
        "Sudah setengah tahun sejak memulai kehidupan asrama kampus. "
        "Awalnya bingung dengan aturan hidup bersama, tapi sekarang "
        "sudah bisa hidup nyaman sambil bekerja sama dengan "
        "teman-teman. Saya merasa banyak belajar hal yang tidak akan "
        "disadari jika sendirian.",
        [
            ("何の生活を始めて半年が経ちましたか。", ["大学の寮生活", "一人暮らし", "実家暮らし", "留学生活"], 0),
            ("最初は何に戸惑いましたか。", ["共同生活のルール", "勉強の難しさ", "食事の味", "交通機関"], 0),
            ("筆者は何を学べた気がしますか。", ["一人では気づけなかったこと", "勉強の内容だけ", "お金の管理だけ", "何も学べなかったこと"], 0),
        ],
    ),
    (
        "taiyoukou_hatten_kiji",
        "Artikel tentang Perkembangan Energi Surya di Rumah",
        "家庭用の太陽光発電が普及しつつあるが、導入費用の高さが依然"
        "として大きな壁となっている。長期的には電気代の節約につな"
        "がるとはいえ、初期投資の負担をどう軽減するかが課題だわけだ。",
        "Pembangkit listrik tenaga surya untuk rumah tangga mulai "
        "meluas, tetapi tingginya biaya pemasangan masih menjadi "
        "hambatan besar. Meskipun dalam jangka panjang bisa "
        "menghemat biaya listrik, bagaimana meringankan beban "
        "investasi awal menjadi tantangan.",
        [
            ("何が普及しつつありますか。", ["家庭用の太陽光発電", "電気自動車", "風力発電所", "原子力発電"], 0),
            ("何が依然として大きな壁となっていますか。", ["導入費用の高さ", "技術の未熟さ", "効果のなさ", "法律の禁止"], 0),
            ("何が課題だと述べられていますか。", ["初期投資の負担をどう軽減するか", "電気を使わないこと", "太陽光をやめること", "何もしないこと"], 0),
        ],
    ),
    (
        "netami_taisho_essay",
        "Esai tentang Menghadapi Rasa Iri",
        "他人の成功を素直に喜べず、心の中で嫉妬してしまうことがある。"
        "しかし、その感情を否定するのではなく、自分にもまだ伸びしろ"
        "があるというサインとして受け止めることもできるわけだ。",
        "Terkadang tidak bisa dengan tulus senang atas kesuksesan "
        "orang lain, dan justru merasa iri di dalam hati. Namun, "
        "alih-alih menolak perasaan itu, kita juga bisa menerimanya "
        "sebagai tanda bahwa diri kita masih punya ruang untuk "
        "berkembang.",
        [
            ("他人の成功に対してどんな感情が生まれることがありますか。", ["嫉妬", "無関心", "喜びだけ", "尊敬だけ"], 0),
            ("この感情をどう受け止めることもできますか。", ["自分にもまだ伸びしろがあるというサイン", "悪いことの証拠", "無視すべきもの", "恥ずべきもの"], 0),
            ("筆者はこの感情をどうすべきだと言っていますか。", ["否定するのではなく受け止める", "完全に否定する", "無視する", "隠す"], 0),
        ],
    ),
    (
        "peer_tutor_taiken",
        "Cerita Pengalaman Menjadi Tutor Sebaya",
        "数学が得意だったことから、クラスメートに勉強を教える役割を"
        "任された。初めは自分の説明が分かりにくいのではないかと心配"
        "だったが、相手の理解度に合わせて教え方を工夫するうちに、"
        "自分自身の理解も深まった。",
        "Karena pandai matematika, saya diberi peran mengajar teman "
        "sekelas belajar. Awalnya khawatir apakah penjelasan saya "
        "sulit dipahami, tapi seiring menyesuaikan cara mengajar "
        "dengan tingkat pemahaman lawan bicara, pemahaman saya "
        "sendiri juga semakin dalam.",
        [
            ("なぜクラスメートに勉強を教える役割を任されましたか。", ["数学が得意だったから", "先生に頼まれたから", "時間があったから", "友達がいなかったから"], 0),
            ("初めはどんな心配がありましたか。", ["自分の説明が分かりにくいのではないか", "時間が足りないのではないか", "誰も来ないのではないか", "お金がもらえないのではないか"], 0),
            ("教え方を工夫するうちにどうなりましたか。", ["自分自身の理解も深まった", "理解が浅くなった", "何も変わらなかった", "もっと分からなくなった"], 0),
        ],
    ),
    (
        "kyaku_motenashi_manaa",
        "Panduan Etika Menerima Tamu di Rumah",
        "家に客を招く際は、事前に部屋を整えておくのはもちろん、相手"
        "が食べられないものがないか確認しておくことも大切だ。過度に"
        "もてなそうとするあまり、かえって相手に気を使わせてしまわな"
        "いよう注意したい。",
        "Saat mengundang tamu ke rumah, tentu saja penting untuk "
        "merapikan ruangan sebelumnya, tapi juga penting mengecek "
        "apakah ada makanan yang tidak bisa dimakan lawan bicara. "
        "Ingin berhati-hati agar tidak terlalu berlebihan menjamu "
        "sehingga justru membuat lawan bicara sungkan.",
        [
            ("家に客を招く際、何を事前に確認しておくことが大切ですか。", ["相手が食べられないものがないか", "相手の好きな色", "相手の仕事", "相手の年齢"], 0),
            ("何に注意したいと言っていますか。", ["過度にもてなそうとして相手に気を使わせないこと", "もてなしすぎないよう何もしないこと", "部屋を汚くしておくこと", "客を呼ばないこと"], 0),
            ("部屋についてどうすることが求められますか。", ["事前に整えておくこと", "何もしないこと", "客に掃除させること", "後で片付けること"], 0),
        ],
    ),
    (
        "shokubutsu_ryouri_trend_kiji",
        "Artikel tentang Tren Makanan Nabati",
        "健康志向や環境意識の高まりを背景に、植物性の食品を選ぶ人が"
        "増えている。肉の代わりに大豆を使った製品の種類も豊富になり、"
        "以前より手軽に取り入れられるようになったわけだ。",
        "Dengan latar belakang meningkatnya kesadaran kesehatan dan "
        "lingkungan, semakin banyak orang yang memilih makanan "
        "berbasis tumbuhan. Jenis produk yang menggunakan kedelai "
        "sebagai pengganti daging pun semakin beragam, sehingga "
        "menjadi lebih mudah diadopsi dibanding sebelumnya.",
        [
            ("何の高まりを背景に植物性の食品を選ぶ人が増えていますか。", ["健康志向や環境意識", "値段の安さ", "流行だけ", "政府の命令"], 0),
            ("肉の代わりに何を使った製品が豊富になりましたか。", ["大豆", "米", "小麦", "魚"], 0),
            ("植物性食品は以前と比べてどうなりましたか。", ["手軽に取り入れられるようになった", "もっと難しくなった", "値段が上がっただけ", "種類が減った"], 0),
        ],
    ),
    (
        "ayamari_taisetsu_essay",
        "Esai tentang Pentingnya Meminta Maaf",
        "自分の非を認めて謝ることは、簡単なようで実は勇気がいる行為"
        "だ。素直に謝ることができる人ほど、周囲からの信頼を得やすい"
        "わけだ。プライドを守るために謝罪を避けることは、長期的には"
        "損になる場合が多い。",
        "Mengakui kesalahan diri sendiri dan meminta maaf, terkesan "
        "mudah tapi sebenarnya perlu keberanian. Semakin bisa dengan "
        "tulus meminta maaf, semakin mudah mendapat kepercayaan dari "
        "sekitar. Menghindari permintaan maaf demi menjaga harga "
        "diri, dalam jangka panjang seringkali justru merugikan.",
        [
            ("自分の非を認めて謝ることはどんな行為ですか。", ["簡単なようで実は勇気がいる行為", "誰にでも簡単な行為", "無意味な行為", "恥ずかしいだけの行為"], 0),
            ("どんな人が周囲からの信頼を得やすいですか。", ["素直に謝ることができる人", "絶対に謝らない人", "何も言わない人", "言い訳ばかりする人"], 0),
            ("プライドを守るために謝罪を避けることはどうなる場合が多いですか。", ["長期的には損になる", "すぐに得になる", "何も変わらない", "もっと信頼される"], 0),
        ],
    ),
    (
        "ikuji_kyuuka_shinsei_tetsuzuki",
        "Petunjuk Prosedur Pengajuan Cuti Melahirkan",
        "育児休暇を取得する場合、まず会社の人事部に相談する必要が"
        "ある。取得希望日の一ヶ月前までに申請書を提出することが一般"
        "的だ。手続きに不明な点があれば、早めに確認しておくことが"
        "望ましい。",
        "Jika akan mengambil cuti melahirkan, pertama-tama perlu "
        "berkonsultasi dengan departemen SDM perusahaan. Umumnya, "
        "formulir pengajuan diserahkan selambat-lambatnya satu bulan "
        "sebelum tanggal yang diinginkan. Jika ada hal yang tidak "
        "jelas dalam prosedur, sebaiknya dikonfirmasi sejak awal.",
        [
            ("育児休暇を取得する場合、まず何をしますか。", ["会社の人事部に相談する", "すぐに休む", "医者に相談する", "家族に相談するだけ"], 0),
            ("申請書はいつまでに提出することが一般的ですか。", ["取得希望日の一ヶ月前まで", "前日まで", "一週間前まで", "一年前まで"], 0),
            ("手続きに不明な点があればどうすることが望ましいですか。", ["早めに確認しておくこと", "何もしないこと", "諦めること", "休暇をやめること"], 0),
        ],
    ),
    (
        "shichou_shuukan_henka_kiji",
        "Artikel tentang Perubahan Kebiasaan Menonton",
        "テレビを決まった時間に見る代わりに、好きな時間に動画配信"
        "サービスで視聴する人が増えている。自分のペースで見られる"
        "自由さが人気の理由だが、次々に見てしまい時間を忘れることも"
        "あるようだ。",
        "Semakin banyak orang yang menonton lewat layanan streaming "
        "di waktu yang disukai, sebagai pengganti menonton TV di jam "
        "yang sudah ditentukan. Kebebasan bisa ditonton sesuai ritme "
        "sendiri adalah alasan popularitasnya, tapi sepertinya juga "
        "ada yang lupa waktu karena terus menonton berturut-turut.",
        [
            ("テレビを決まった時間に見る代わりに何をする人が増えていますか。", ["好きな時間に動画配信サービスで視聴すること", "テレビを全く見ないこと", "映画館に行くこと", "ラジオを聴くこと"], 0),
            ("この方法が人気の理由は何ですか。", ["自分のペースで見られる自由さ", "値段が安いこと", "内容が面白いことだけ", "広告が少ないことだけ"], 0),
            ("どんなことがあるようですか。", ["次々に見てしまい時間を忘れること", "すぐに飽きてしまうこと", "内容を覚えられないこと", "目が良くなること"], 0),
        ],
    ),
    (
        "chiimu_wa_imi_essay",
        "Esai tentang Menemukan Arti Kerja Tim",
        "一人で完結できる仕事を好んでいたが、あるプロジェクトでチーム"
        "で働く経験をした。意見の違いに苦労することもあったが、一人"
        "では思いつかなかったアイデアが生まれる瞬間に、チームで働く"
        "意味を実感した。",
        "Saya lebih suka pekerjaan yang bisa diselesaikan sendiri, "
        "tapi mengalami bekerja dalam tim di suatu proyek. Ada "
        "kalanya kesulitan dengan perbedaan pendapat, tapi pada saat "
        "muncul ide yang tidak akan terpikirkan sendirian, saya "
        "merasakan makna bekerja dalam tim.",
        [
            ("筆者はどんな仕事を好んでいましたか。", ["一人で完結できる仕事", "チームでの仕事だけ", "難しい仕事", "簡単な仕事だけ"], 0),
            ("何に苦労することもありましたか。", ["意見の違い", "時間の管理", "お金の問題", "場所の問題"], 0),
            ("何にチームで働く意味を実感しましたか。", ["一人では思いつかなかったアイデアが生まれる瞬間", "給料が増えた瞬間", "仕事が終わった瞬間", "一人になれた瞬間"], 0),
        ],
    ),
    (
        "honyaku_volunteer_taiken",
        "Cerita Pengalaman Menjadi Penerjemah Sukarela",
        "地域に住む外国人のための翻訳ボランティアに参加した。専門"
        "用語の翻訳には苦労したが、感謝の言葉をもらったときは、自分"
        "の語学力が誰かの役に立っていることを実感できた。",
        "Saya berpartisipasi dalam sukarelawan penerjemahan untuk "
        "warga asing yang tinggal di daerah. Kesulitan menerjemahkan "
        "istilah khusus, tapi ketika mendapat ucapan terima kasih, "
        "saya bisa merasakan bahwa kemampuan bahasa saya berguna "
        "bagi seseorang.",
        [
            ("何のボランティアに参加しましたか。", ["地域に住む外国人のための翻訳ボランティア", "清掃ボランティア", "募金活動", "高齢者サポート"], 0),
            ("何に苦労しましたか。", ["専門用語の翻訳", "簡単な会話", "道案内", "買い物"], 0),
            ("感謝の言葉をもらったとき、何を実感できましたか。", ["自分の語学力が誰かの役に立っていること", "もっと勉強が必要なこと", "翻訳が嫌いなこと", "時間の無駄だったこと"], 0),
        ],
    ),
    (
        "jidounten_hatten_kiji",
        "Artikel tentang Perkembangan Mobil Otonom",
        "自動運転技術の実用化に向けた実証実験が各地で進められている。"
        "安全性の確保が最優先課題である一方、法整備が技術の進歩に"
        "追いついていない現状もあるわけだ。",
        "Uji coba menuju realisasi praktis teknologi mengemudi "
        "otomatis sedang berlangsung di berbagai daerah. Sementara "
        "jaminan keamanan menjadi prioritas utama, ada juga "
        "kenyataan bahwa penataan hukum belum mengejar kemajuan "
        "teknologi.",
        [
            ("各地で何が進められていますか。", ["自動運転技術の実用化に向けた実証実験", "道路の拡張工事", "新しい鉄道の建設", "電気自動車の販売停止"], 0),
            ("最優先課題は何ですか。", ["安全性の確保", "値段の安さ", "デザインの良さ", "速さ"], 0),
            ("どんな現状がありますか。", ["法整備が技術の進歩に追いついていない", "法整備が完璧に整っている", "技術が全く進んでいない", "誰も興味がない"], 0),
        ],
    ),
    (
        "nyuushi_shippai_taisho_essay",
        "Esai tentang Menghadapi Kegagalan Ujian Masuk",
        "第一志望の入試に失敗したとき、世界が終わったような気持ちに"
        "なった。しかし、時間が経つにつれて、その経験が自分を成長"
        "させてくれたことに気づいた。失敗は終わりではなく、新しい"
        "始まりになることもあるわけだ。",
        "Ketika gagal ujian masuk pilihan pertama, saya merasa "
        "seperti dunia berakhir. Namun, seiring berjalannya waktu, "
        "saya menyadari bahwa pengalaman itu membuat saya "
        "berkembang. Kegagalan bukan akhir, tapi bisa juga menjadi "
        "awal yang baru.",
        [
            ("第一志望の入試に失敗したとき、どんな気持ちになりましたか。", ["世界が終わったような気持ち", "何も感じない気持ち", "嬉しい気持ち", "安心した気持ち"], 0),
            ("時間が経つにつれて何に気づきましたか。", ["その経験が自分を成長させてくれたこと", "失敗は避けるべきだということ", "勉強は無駄だということ", "何も変わらないこと"], 0),
            ("失敗は何になることもあると述べられていますか。", ["新しい始まり", "完全な終わり", "無意味なもの", "恥ずべきこと"], 0),
        ],
    ),
    (
        "kankou_guide_taiken",
        "Cerita Pengalaman Menjadi Pemandu Wisata",
        "大学の休みを利用して、外国人観光客向けの観光ガイドのアルバ"
        "イトを始めた。歴史の知識を英語で伝えるのは大変だったが、"
        "観光客が喜んでくれる姿を見ると、やりがいを感じた。",
        "Memanfaatkan liburan kampus, saya mulai kerja paruh waktu "
        "sebagai pemandu wisata untuk turis asing. Menyampaikan "
        "pengetahuan sejarah dalam bahasa Inggris itu berat, tapi "
        "ketika melihat turis senang, saya merasakan kepuasan.",
        [
            ("何のアルバイトを始めましたか。", ["外国人観光客向けの観光ガイド", "レストランの店員", "塾の講師", "翻訳の仕事"], 0),
            ("何が大変でしたか。", ["歴史の知識を英語で伝えること", "道を歩くこと", "写真を撮ること", "お金を数えること"], 0),
            ("何にやりがいを感じましたか。", ["観光客が喜んでくれる姿を見ること", "お金をもらうこと", "休みが多いこと", "英語を話すことだけ"], 0),
        ],
    ),
    (
        "ichiba_kaimono_manaa",
        "Panduan Etika Berbelanja di Pasar Tradisional",
        "伝統的な市場で買い物をする際は、値段交渉が一般的な文化として"
        "根付いている場合が多い。ただし、あまりに強引な値引き要求は、"
        "売り手に失礼になることもあるため、節度を持つことが大切だ。",
        "Saat berbelanja di pasar tradisional, tawar-menawar harga "
        "seringkali sudah mengakar sebagai budaya umum. Namun, "
        "permintaan diskon yang terlalu memaksa juga bisa menjadi "
        "tidak sopan terhadap penjual, jadi penting untuk memiliki "
        "batasan.",
        [
            ("伝統的な市場ではどんな文化が根付いている場合が多いですか。", ["値段交渉", "無料配布", "予約制", "現金のみ"], 0),
            ("どんな要求は売り手に失礼になることがありますか。", ["あまりに強引な値引き要求", "丁寧な質問", "静かな会話", "ゆっくり選ぶこと"], 0),
            ("何が大切だと述べられていますか。", ["節度を持つこと", "絶対に値引きしないこと", "たくさん値引きさせること", "何も言わないこと"], 0),
        ],
    ),
    (
        "cafe_hataraku_trend_kiji",
        "Artikel tentang Tren Bekerja dari Kafe",
        "リモートワークの普及に伴い、カフェで仕事をする人の姿が珍し"
        "くなくなった。自宅とは違う適度な緊張感が集中力を高めると"
        "いう声がある一方、長時間の利用がマナー違反だと感じる店側の"
        "意見もあるようだ。",
        "Seiring meluasnya kerja jarak jauh, sosok orang bekerja di "
        "kafe tidak lagi jarang terlihat. Di satu sisi ada suara "
        "yang mengatakan ketegangan sedang yang berbeda dari rumah "
        "meningkatkan konsentrasi, di sisi lain sepertinya ada juga "
        "pendapat pihak toko bahwa penggunaan dalam waktu lama "
        "merupakan pelanggaran etika.",
        [
            ("何の普及に伴いカフェで働く人が増えましたか。", ["リモートワーク", "カフェの割引", "無料Wi-Fi", "新しい法律"], 0),
            ("カフェで働くことにはどんな利点があるという声がありますか。", ["適度な緊張感が集中力を高める", "値段が安い", "誰にも会わない", "静かすぎる"], 0),
            ("店側にはどんな意見もあるようですか。", ["長時間の利用がマナー違反だと感じる意見", "もっと利用してほしいという意見", "無料にしてほしいという意見", "何も気にしないという意見"], 0),
        ],
    ),
    (
        "kikukoto_taisetsu_essay",
        "Esai tentang Pentingnya Mendengarkan Orang Lain",
        "会話において、自分の意見を言うことばかりに気を取られがちだ"
        "が、相手の話をしっかり聞くことこそが、良い人間関係を築く"
        "基本なのかもしれない。聞く姿勢は、話す技術以上に大切な場合"
        "が多いわけだ。",
        "Dalam percakapan, seringkali terlalu fokus pada mengatakan "
        "pendapat sendiri, tapi mendengarkan cerita lawan bicara "
        "dengan baik mungkin justru dasar dalam membangun hubungan "
        "yang baik. Sikap mendengarkan seringkali lebih penting "
        "daripada teknik berbicara.",
        [
            ("会話において何に気を取られがちですか。", ["自分の意見を言うことばかり", "相手の話を聞くことばかり", "沈黙することばかり", "早く終わらせることばかり"], 0),
            ("何が良い人間関係を築く基本かもしれませんか。", ["相手の話をしっかり聞くこと", "たくさん話すこと", "早口で話すこと", "何も言わないこと"], 0),
            ("聞く姿勢は何以上に大切な場合が多いですか。", ["話す技術", "お金", "時間", "場所"], 0),
        ],
    ),
    (
        "pasupooto_koushin_tetsuzuki",
        "Petunjuk Prosedur Pengajuan Perpanjangan Paspor",
        "パスポートの有効期限が近づいたら、更新の手続きをする必要が"
        "ある。申請書、写真、そして古いパスポートを持って、パスポー"
        "トセンターに行こう。通常、発行までに一週間程度かかる。",
        "Jika masa berlaku paspor mendekati habis, perlu melakukan "
        "prosedur pembaruan. Bawa formulir pengajuan, foto, dan "
        "paspor lama, lalu pergi ke pusat paspor. Biasanya butuh "
        "sekitar satu minggu sampai terbit.",
        [
            ("パスポートの有効期限が近づいたら何をする必要がありますか。", ["更新の手続き", "再発行の依頼だけ", "新しい申請だけ", "何もしなくていい"], 0),
            ("何を持っていきますか。", ["申請書、写真、古いパスポート", "現金だけ", "写真だけ", "何も持っていかない"], 0),
            ("発行までどのくらいかかりますか。", ["一週間程度", "一ヶ月程度", "一日程度", "三ヶ月程度"], 0),
        ],
    ),
    (
        "fukukaimono_shuukan_henka_kiji",
        "Artikel tentang Perubahan Kebiasaan Berbelanja Pakaian",
        "大量生産・大量消費への反省から、質の良い服を長く着る消費"
        "スタイルが見直されつつある。安価な服を頻繁に買い替えるより"
        "も、丁寧に手入れをしながら長く使うことに価値を感じる人が"
        "増えているようだ。",
        "Dari refleksi terhadap produksi dan konsumsi massal, gaya "
        "konsumsi memakai pakaian berkualitas baik dalam waktu lama "
        "mulai ditinjau kembali. Sepertinya semakin banyak orang "
        "yang merasakan nilai dalam menggunakan barang dalam waktu "
        "lama sambil merawat dengan teliti, dibanding sering "
        "mengganti pakaian murah.",
        [
            ("何への反省から消費スタイルが見直されつつありますか。", ["大量生産・大量消費", "高価格帯の服", "手作りの服", "輸入品"], 0),
            ("どんな消費スタイルが見直されていますか。", ["質の良い服を長く着ること", "安い服をたくさん買うこと", "服を買わないこと", "毎日新しい服を買うこと"], 0),
            ("何に価値を感じる人が増えていますか。", ["丁寧に手入れをしながら長く使うこと", "頻繁に買い替えること", "高い服を買うことだけ", "流行を追うことだけ"], 0),
        ],
    ),
    (
        "shippai_imi_hakken_essay",
        "Esai tentang Menemukan Makna dalam Kegagalan",
        "挑戦した結果うまくいかなかったことを、多くの人は避けたいと"
        "感じるだろう。しかし、何も挑戦しなければ失敗もない代わりに、"
        "成長の機会も失われてしまうわけだ。失敗を恐れず一歩を踏み"
        "出す勇気こそが大切なのだと思う。",
        "Banyak orang mungkin ingin menghindari hasil yang tidak "
        "berjalan baik setelah mencoba tantangan. Namun, jika tidak "
        "mencoba apa pun, meskipun tidak ada kegagalan, kesempatan "
        "untuk berkembang juga hilang. Saya pikir keberanian untuk "
        "melangkah maju tanpa takut gagal itulah yang penting.",
        [
            ("多くの人は何を避けたいと感じるでしょう。", ["挑戦した結果うまくいかなかったこと", "挑戦すること自体", "成功すること", "何もしないこと"], 0),
            ("何も挑戦しないとどうなりますか。", ["成長の機会も失われる", "もっと幸せになる", "何も変わらない", "失敗が増える"], 0),
            ("筆者は何が大切だと思っていますか。", ["失敗を恐れず一歩を踏み出す勇気", "絶対に失敗しないこと", "挑戦しないこと", "完璧を目指すこと"], 0),
        ],
    ),
    (
        "toshokan_volunteer_taiken",
        "Cerita Pengalaman Menjadi Relawan Perpustakaan",
        "地域の図書館で本の整理を手伝うボランティアに参加した。単調"
        "な作業に思えたが、本を探しに来た子供に「この本どこにあり"
        "ますか」と聞かれ、案内できたときは、小さな達成感を味わえた。",
        "Saya berpartisipasi dalam sukarelawan membantu menata buku "
        "di perpustakaan daerah. Terasa pekerjaan monoton, tapi "
        "ketika ditanya anak yang datang mencari buku \"buku ini ada "
        "di mana\", dan bisa mengarahkan, saya merasakan pencapaian "
        "kecil.",
        [
            ("何のボランティアに参加しましたか。", ["図書館で本の整理を手伝うボランティア", "清掃ボランティア", "読み聞かせボランティア", "募金活動"], 0),
            ("この作業は最初どう思えましたか。", ["単調な作業", "とても楽しい作業", "難しい作業", "危険な作業"], 0),
            ("何を味わえましたか。", ["小さな達成感", "大きな失望", "強い疲労感だけ", "何も感じなかった"], 0),
        ],
    ),
]
...
N2_ENTRIES = [
    ...
    (
        "journalism_chousa_rinri_essay",
        "Esai tentang Etika Jurnalisme Investigasi",
        "調査報道は権力の不正を暴く重要な役割を担っているにもかかわ"
        "らず、情報源の保護と説明責任の両立という難題を常に抱えて"
        "いる。真実を追求する使命と、関係者への配慮とのバランスが、"
        "記者一人一人に問われている。",
        "Meskipun jurnalisme investigasi memiliki peran penting "
        "mengungkap kecurangan kekuasaan, selalu membawa masalah "
        "sulit yaitu keseimbangan antara perlindungan sumber "
        "informasi dan akuntabilitas. Setiap jurnalis dipertanyakan "
        "bagaimana menyeimbangkan misi mengejar kebenaran dengan "
        "pertimbangan terhadap pihak terkait.",
        [
            ("調査報道はどんな役割を担っていますか。", ["権力の不正を暴く役割", "娯楽を提供する役割", "広告を集める役割", "何もしない役割"], 0),
            ("調査報道はどんな難題を抱えていますか。", ["情報源の保護と説明責任の両立", "お金の不足だけ", "読者の減少だけ", "技術的な問題だけ"], 0),
            ("何が記者一人一人に問われていますか。", ["真実の追求と関係者への配慮のバランス", "早く書くことだけ", "有名になることだけ", "お金を稼ぐことだけ"], 0),
        ],
    ),
    (
        "iryou_seido_kaikaku_kiji",
        "Artikel tentang Reformasi Sistem Kesehatan",
        "医療費の増大をきっかけに、制度改革の議論が活発化している。"
        "予防医療の充実をきっかけとして、将来的な医療費抑制を図る"
        "取り組みも進められているが、効果が表れるまでには時間がかか"
        "るだろう。",
        "Dengan meningkatnya biaya medis sebagai pemicu, diskusi "
        "reformasi sistem semakin aktif. Dengan peningkatan pengobatan "
        "preventif sebagai pemicu, upaya untuk mengendalikan biaya "
        "medis di masa depan juga sedang dilakukan, tetapi mungkin "
        "butuh waktu sampai efeknya terlihat.",
        [
            ("何をきっかけに制度改革の議論が活発化していますか。", ["医療費の増大", "人口の減少", "技術革新", "国際競争"], 0),
            ("何をきっかけとして医療費抑制を図る取り組みが進められていますか。", ["予防医療の充実", "増税だけ", "病院の削減だけ", "医師の増員だけ"], 0),
            ("効果が表れるまでにどうだと述べられていますか。", ["時間がかかるだろう", "すぐに表れる", "効果はない", "誰にも分からない"], 0),
        ],
    ),
    (
        "ai_koyou_eikyou_bunseki",
        "Analisis tentang Dampak Kecerdasan Buatan pada Lapangan Kerja",
        "AIの活用が進んでいるにもかかわらず、雇用全体が急激に減少"
        "しているわけではないという分析結果もある。むしろ、新たな"
        "職種が生まれる一方で、既存の業務内容が変化していくという"
        "のが実態に近いようだ。",
        "Meskipun pemanfaatan AI berkembang, ada juga hasil analisis "
        "yang menunjukkan bahwa keseluruhan lapangan kerja tidak "
        "menurun drastis. Justru, sepertinya kenyataan yang lebih "
        "mendekati adalah munculnya pekerjaan baru di satu sisi, "
        "sementara isi pekerjaan yang sudah ada juga berubah.",
        [
            ("AIの活用が進んでいるのに、雇用全体はどうですか。", ["急激に減少しているわけではない", "急激に増加している", "完全になくなった", "変化していない"], 0),
            ("分析結果によると何が生まれていますか。", ["新たな職種", "新たな税金", "新たな戦争", "新たな病気"], 0),
            ("既存の業務内容はどうなっていますか。", ["変化していく", "全くなくなる", "そのまま残る", "増加するだけ"], 0),
        ],
    ),
    (
        "toshi_idou_pattern_report",
        "Laporan tentang Perubahan Pola Migrasi Perkotaan",
        "地方から都市への一極集中が続く一方で、生活コストの高さを"
        "きっかけに、地方移住を選択する人も一定数存在する。両者の"
        "バランスをいかに取るかが、今後の国土政策における重要な論点"
        "となるだろう。",
        "Sementara konsentrasi tunggal dari daerah ke kota terus "
        "berlanjut, dengan tingginya biaya hidup sebagai pemicu, ada "
        "juga sejumlah orang yang memilih pindah ke daerah. Bagaimana "
        "menyeimbangkan keduanya akan menjadi poin diskusi penting "
        "dalam kebijakan tata ruang nasional ke depan.",
        [
            ("地方から都市への何が続いていますか。", ["一極集中", "人口の均等化", "経済の停滞", "過疎化の解消"], 0),
            ("何をきっかけに地方移住を選択する人がいますか。", ["生活コストの高さ", "仕事の多さ", "気候の良さだけ", "流行"], 0),
            ("今後の国土政策における重要な論点は何ですか。", ["両者のバランスをいかに取るか", "都市の完全な廃止", "地方の完全な廃止", "何もしないこと"], 0),
        ],
    ),
    (
        "media_shinrai_kiki_editorial",
        "Editorial tentang Krisis Kepercayaan Media",
        "フェイクニュースの拡散をきっかけに、既存メディアへの信頼も"
        "揺らいでいるにもかかわらず、事実確認を徹底した報道の価値が"
        "見直される動きも見られる。情報過多の時代だからこそ、信頼"
        "できる情報源の重要性は増している。",
        "Meskipun kepercayaan pada media yang sudah ada juga goyah "
        "dengan penyebaran berita palsu sebagai pemicu, terlihat juga "
        "gerakan untuk meninjau kembali nilai pemberitaan yang "
        "menyeluruh memeriksa fakta. Justru karena era kelebihan "
        "informasi, pentingnya sumber informasi yang bisa dipercaya "
        "semakin meningkat.",
        [
            ("何をきっかけに既存メディアへの信頼が揺らいでいますか。", ["フェイクニュースの拡散", "経済成長", "技術革新", "人口増加"], 0),
            ("どんな動きが見られますか。", ["事実確認を徹底した報道の価値を見直す動き", "メディアを全て廃止する動き", "フェイクニュースを増やす動き", "何もしない動き"], 0),
            ("情報過多の時代だからこそ何の重要性が増していますか。", ["信頼できる情報源", "情報の量だけ", "速報性だけ", "娯楽性だけ"], 0),
        ],
    ),
    (
        "kigyou_sekinin_genkai_essay",
        "Esai tentang Batas Tanggung Jawab Perusahaan",
        "企業の社会的責任が重視される時代であるにもかかわらず、その"
        "範囲がどこまで及ぶべきかについては、意見が分かれるところだ。"
        "株主への利益還元と社会貢献のバランスをいかに取るかは、簡単"
        "には答えの出ない経営課題である。",
        "Meskipun ini adalah era di mana tanggung jawab sosial "
        "perusahaan dipentingkan, mengenai sejauh mana cakupannya "
        "harus mencapai, pendapatnya terbagi. Bagaimana menyeimbangkan "
        "pengembalian keuntungan kepada pemegang saham dan kontribusi "
        "sosial adalah masalah manajemen yang tidak mudah dijawab.",
        [
            ("企業の社会的責任について、意見はどうですか。", ["その範囲についてはどこまで及ぶべきか意見が分かれる", "誰もが同じ意見を持つ", "全く重要ではない", "既に完全に解決している"], 0),
            ("何と何のバランスが問われていますか。", ["株主への利益還元と社会貢献", "給料の高さと低さ", "国内と海外", "過去と未来だけ"], 0),
            ("筆者はどんな課題だと述べていますか。", ["簡単には答えの出ない経営課題", "すぐに解決できる課題", "存在しない課題", "誰も気にしない課題"], 0),
        ],
    ),
    (
        "kyouiku_byoudou_kadai_kiji",
        "Artikel tentang Tantangan Kesetaraan Pendidikan",
        "教育の機会均等をきっかけに様々な支援制度が整備されてきた"
        "にもかかわらず、家庭の経済状況による学力格差は依然として"
        "存在している。制度の整備だけでなく、実質的な機会均等の実現"
        "が今後の課題だ。",
        "Meskipun berbagai sistem dukungan telah dibangun dengan "
        "kesetaraan kesempatan pendidikan sebagai pemicu, kesenjangan "
        "kemampuan akademik akibat kondisi ekonomi keluarga masih "
        "tetap ada. Bukan hanya penataan sistem, realisasi kesetaraan "
        "kesempatan yang substansial adalah tantangan ke depan.",
        [
            ("何をきっかけに様々な支援制度が整備されてきましたか。", ["教育の機会均等", "経済成長", "人口増加", "国際競争"], 0),
            ("依然として何が存在していますか。", ["家庭の経済状況による学力格差", "完全な平等", "学力の均一化", "教育制度の廃止"], 0),
            ("今後の課題は何ですか。", ["実質的な機会均等の実現", "制度の廃止", "教育費の増加だけ", "何もしないこと"], 0),
        ],
    ),
    (
        "kazoku_kachikan_gendai_bunseki",
        "Analisis tentang Perubahan Nilai Keluarga Modern",
        "従来の家族形態にとらわれない、多様な家族のあり方が社会に"
        "受け入れられつつある。血縁関係のみを家族とみなす価値観から、"
        "支え合う関係性そのものを重視する方向へと、意識が変化して"
        "いるようだ。",
        "Bentuk keluarga yang beragam, yang tidak terikat pada bentuk "
        "keluarga tradisional, mulai diterima masyarakat. Sepertinya "
        "kesadaran sedang berubah dari nilai yang menganggap keluarga "
        "hanya hubungan darah, menuju arah yang mementingkan hubungan "
        "saling mendukung itu sendiri.",
        [
            ("どんな家族のあり方が社会に受け入れられつつありますか。", ["従来の家族形態にとらわれない多様な家族のあり方", "伝統的な家族形態だけ", "家族がない生活", "一人暮らしだけ"], 0),
            ("何を家族とみなす価値観から意識が変化していますか。", ["血縁関係のみ", "支え合う関係性", "お金の関係", "法律上の関係だけ"], 0),
            ("意識はどの方向へ変化していますか。", ["支え合う関係性そのものを重視する方向", "血縁関係だけを重視する方向", "家族を軽視する方向", "何も変わらない方向"], 0),
        ],
    ),
    (
        "koutsuu_kakushin_report_n2",
        "Laporan tentang Inovasi dalam Transportasi Umum",
        "自動運転技術の実用化をきっかけに、公共交通のあり方が見直さ"
        "れつつある。過疎地域における移動手段の確保という課題に"
        "対しても、新しい技術が解決策となる可能性が期待されている。",
        "Dengan realisasi praktis teknologi mengemudi otomatis sebagai "
        "pemicu, bentuk transportasi umum mulai ditinjau kembali. "
        "Terhadap tantangan memastikan sarana transportasi di daerah "
        "terpencil pun, diharapkan teknologi baru bisa menjadi "
        "solusi.",
        [
            ("何をきっかけに公共交通のあり方が見直されつつありますか。", ["自動運転技術の実用化", "人口増加", "財政赤字", "国際競争"], 0),
            ("過疎地域にはどんな課題がありますか。", ["移動手段の確保", "人口過多", "経済の急成長", "教育の充実"], 0),
            ("新しい技術は何になる可能性が期待されていますか。", ["解決策", "新たな問題", "無関係なもの", "障害"], 0),
        ],
    ),
    (
        "kojin_jiyuu_kyoudou_rieki_essay",
        "Esai tentang Dilema Kebebasan Individu dan Kepentingan Bersama",
        "個人の自由を最大限尊重すべきだという考え方があるにもかか"
        "わらず、社会全体の利益のためには一定の制約もやむを得ない"
        "場合がある。この二つの価値をどう調和させるかは、民主主義"
        "社会が永遠に向き合い続ける課題なのかもしれない。",
        "Meskipun ada pemikiran bahwa kebebasan individu harus "
        "dihormati secara maksimal, ada kalanya pembatasan tertentu "
        "tidak bisa dihindari demi kepentingan seluruh masyarakat. "
        "Bagaimana menyelaraskan kedua nilai ini mungkin adalah "
        "tantangan yang akan terus dihadapi masyarakat demokratis "
        "selamanya.",
        [
            ("どんな考え方がありますか。", ["個人の自由を最大限尊重すべきだという考え方", "個人の自由は不要だという考え方", "社会は個人より重要ではないという考え方", "自由には価値がないという考え方"], 0),
            ("社会全体の利益のために何がやむを得ない場合がありますか。", ["一定の制約", "完全な自由の放棄", "個人の消滅", "法律の廃止"], 0),
            ("筆者はこの課題をどう捉えていますか。", ["民主主義社会が永遠に向き合い続ける課題", "すぐに解決できる課題", "存在しない課題", "誰も気にしない課題"], 0),
        ],
    ),
    (
        "kokoku_rinri_digital_essay",
        "Esai tentang Etika Periklanan Digital",
        "ターゲティング広告の精度が向上する一方で、個人情報の利用"
        "範囲についての透明性が十分に確保されているとは言い難い。"
        "消費者の利便性と、プライバシーへの配慮という二つの要請を、"
        "企業はどう両立させるべきか問われている。",
        "Sementara akurasi iklan bertarget semakin meningkat, sulit "
        "dikatakan bahwa transparansi mengenai cakupan penggunaan "
        "informasi pribadi sudah cukup terjamin. Perusahaan "
        "dipertanyakan bagaimana menyeimbangkan dua tuntutan yaitu "
        "kenyamanan konsumen dan kepedulian terhadap privasi.",
        [
            ("何の精度が向上していますか。", ["ターゲティング広告", "テレビ広告だけ", "新聞広告だけ", "口コミ"], 0),
            ("何が十分に確保されているとは言い難いですか。", ["個人情報の利用範囲についての透明性", "広告の量", "広告の値段", "広告のデザイン"], 0),
            ("企業は何をどう両立させるべきか問われていますか。", ["消費者の利便性とプライバシーへの配慮", "利益と損失", "国内と海外事業", "過去と未来だけ"], 0),
        ],
    ),
    (
        "koyou_seido_kaikaku_kiji",
        "Artikel tentang Reformasi Sistem Ketenagakerjaan",
        "終身雇用を前提とした従来の雇用制度をきっかけに形成されて"
        "きた社会保障の仕組みは、働き方の多様化にもかかわらず、"
        "十分に対応しきれていない部分がある。制度全体の見直しが急務"
        "だ。",
        "Sistem jaminan sosial yang dibentuk dengan sistem "
        "ketenagakerjaan tradisional berbasis kerja seumur hidup "
        "sebagai pemicu, meskipun cara kerja semakin beragam, ada "
        "bagian yang belum cukup teratasi. Peninjauan ulang "
        "keseluruhan sistem sangat mendesak.",
        [
            ("社会保障の仕組みは何をきっかけに形成されてきましたか。", ["終身雇用を前提とした従来の雇用制度", "フリーランスの増加", "移民の増加", "技術革新だけ"], 0),
            ("働き方の多様化にもかかわらず何がありますか。", ["十分に対応しきれていない部分", "完全に対応できている部分だけ", "制度が不要な部分", "誰も困っていない部分"], 0),
            ("何が急務だと述べられていますか。", ["制度全体の見直し", "終身雇用の廃止だけ", "雇用の停止", "何もしないこと"], 0),
        ],
    ),
    (
        "jidouka_retail_eikyou_bunseki",
        "Analisis tentang Dampak Otomasi pada Industri Ritel",
        "セルフレジや在庫管理の自動化が進んでいるにもかかわらず、"
        "接客そのものの価値が失われているわけではないという見方も"
        "ある。効率化と人的サービスの両立をどう図るかが、小売業界"
        "における重要な経営課題となっている。",
        "Meskipun swalayan kasir dan otomatisasi manajemen stok "
        "berkembang, ada juga pandangan bahwa nilai layanan "
        "pelanggan itu sendiri tidak hilang. Bagaimana mengupayakan "
        "keseimbangan antara efisiensi dan layanan manusia menjadi "
        "tantangan manajemen penting di industri ritel.",
        [
            ("何が進んでいますか。", ["セルフレジや在庫管理の自動化", "店舗数の増加", "従業員の増加", "価格の下落だけ"], 0),
            ("どんな見方もありますか。", ["接客そのものの価値が失われているわけではないという見方", "接客は完全に不要だという見方", "自動化は失敗だという見方", "誰も店に行かなくなるという見方"], 0),
            ("小売業界における重要な経営課題は何ですか。", ["効率化と人的サービスの両立", "従業員の削減だけ", "店舗の全廃止", "価格の上昇だけ"], 0),
        ],
    ),
    (
        "media_shouhi_pattern_report",
        "Laporan tentang Perubahan Pola Konsumsi Media",
        "従来のマスメディアへの接触時間が減少する一方で、個人が発信"
        "するコンテンツへの消費時間は増加傾向にある。この変化を"
        "きっかけに、広告業界のビジネスモデルも根本的な見直しを迫ら"
        "れている。",
        "Sementara waktu kontak dengan media massa tradisional "
        "menurun, waktu konsumsi konten yang disebarkan individu "
        "cenderung meningkat. Dengan perubahan ini sebagai pemicu, "
        "model bisnis industri periklanan juga dituntut untuk "
        "ditinjau ulang secara mendasar.",
        [
            ("何が減少していますか。", ["従来のマスメディアへの接触時間", "個人が発信するコンテンツへの消費時間", "スマートフォンの利用時間", "動画配信の視聴時間"], 0),
            ("個人が発信するコンテンツへの消費時間はどうですか。", ["増加傾向", "減少傾向", "変化なし", "消滅"], 0),
            ("何をきっかけに広告業界のビジネスモデルが見直しを迫られていますか。", ["この消費パターンの変化", "法律の改正だけ", "景気後退だけ", "人口減少だけ"], 0),
        ],
    ),
    (
        "ginkou_shinrai_kiki_editorial",
        "Editorial tentang Krisis Kepercayaan Perbankan",
        "一部金融機関の経営破綻をきっかけに、銀行システム全体への"
        "信頼が揺らいでいるにもかかわらず、預金保険制度の存在が過度"
        "な不安の広がりを一定程度抑えている。制度への理解を広める"
        "ことも、信頼回復には欠かせない。",
        "Meskipun kepercayaan terhadap seluruh sistem perbankan "
        "goyah dengan kebangkrutan sebagian lembaga keuangan sebagai "
        "pemicu, keberadaan sistem asuransi deposito menekan "
        "penyebaran kecemasan berlebihan sampai tingkat tertentu. "
        "Menyebarkan pemahaman tentang sistem juga tidak bisa "
        "dihindari untuk pemulihan kepercayaan.",
        [
            ("何をきっかけに銀行システム全体への信頼が揺らいでいますか。", ["一部金融機関の経営破綻", "政府の政策変更だけ", "国際紛争だけ", "技術的な問題だけ"], 0),
            ("何が過度な不安の広がりを一定程度抑えていますか。", ["預金保険制度の存在", "政府の口約束だけ", "銀行の広告だけ", "何もない"], 0),
            ("信頼回復には何が欠かせませんか。", ["制度への理解を広めること", "銀行を全て廃止すること", "預金を禁止すること", "何もしないこと"], 0),
        ],
    ),
    (
        "kojin_sekinin_kikou_essay",
        "Esai tentang Batas Tanggung Jawab Individu dalam Krisis Iklim",
        "気候変動への対応は個人のライフスタイル変革だけで解決できる"
        "問題ではないにもかかわらず、その責任の多くが個人の選択に"
        "帰されがちだ。構造的な課題への取り組みと、個人の意識改革"
        "は、本来切り離して論じるべきではないだろう。",
        "Meskipun penanganan perubahan iklim bukan masalah yang bisa "
        "diselesaikan hanya dengan transformasi gaya hidup individu, "
        "sebagian besar tanggung jawabnya cenderung dilimpahkan pada "
        "pilihan individu. Upaya terhadap tantangan struktural dan "
        "reformasi kesadaran individu, seharusnya tidak dibahas "
        "secara terpisah.",
        [
            ("気候変動への対応は何だけで解決できる問題ではありませんか。", ["個人のライフスタイル変革", "政府の政策", "企業の努力だけ", "国際協力だけ"], 0),
            ("その責任の多くは何に帰されがちですか。", ["個人の選択", "企業の責任だけ", "政府の責任だけ", "誰の責任でもないこと"], 0),
            ("筆者は何を切り離して論じるべきではないと考えていますか。", ["構造的な課題への取り組みと個人の意識改革", "経済成長と環境保護だけ", "過去と未来だけ", "国内問題と国際問題だけ"], 0),
        ],
    ),
    (
        "mental_health_shokuba_kadai_kiji",
        "Artikel tentang Tantangan Kesehatan Mental di Tempat Kerja",
        "職場におけるメンタルヘルスの重要性が認識されつつあるにも"
        "かかわらず、実際に不調を訴えることへの心理的な抵抗感は根強"
        "く残っている。相談しやすい環境づくりが、企業にとって今後"
        "ますます重要な課題となるだろう。",
        "Meskipun pentingnya kesehatan mental di tempat kerja mulai "
        "disadari, resistensi psikologis terhadap mengungkapkan "
        "gangguan yang sebenarnya masih kuat bertahan. Menciptakan "
        "lingkungan yang mudah untuk berkonsultasi akan menjadi "
        "tantangan yang semakin penting bagi perusahaan ke depan.",
        [
            ("何の重要性が認識されつつありますか。", ["職場におけるメンタルヘルス", "給料の高さ", "労働時間の短さだけ", "福利厚生の充実だけ"], 0),
            ("何が根強く残っていますか。", ["不調を訴えることへの心理的な抵抗感", "メンタルヘルスへの関心のなさ", "会社への信頼", "仕事への熱意"], 0),
            ("企業にとって今後何が重要な課題となるでしょうか。", ["相談しやすい環境づくり", "労働時間の延長", "給料の削減", "競争の激化"], 0),
        ],
    ),
    (
        "kachikan_shouhi_z_bunseki2",
        "Analisis tentang Perubahan Nilai Konsumsi Generasi Muda",
        "モノの所有よりも体験そのものに価値を見出す消費傾向が、若い"
        "世代を中心に広がっている。この背景には、限られた資源を"
        "きっかけに、何を大切にするかという価値観の転換があるよう"
        "だ。",
        "Kecenderungan konsumsi yang menemukan nilai pada pengalaman "
        "itu sendiri daripada kepemilikan barang, meluas terutama "
        "di kalangan generasi muda. Di balik ini, sepertinya ada "
        "pergeseran nilai tentang apa yang dianggap penting, dengan "
        "sumber daya terbatas sebagai pemicu.",
        [
            ("どんな消費傾向が若い世代を中心に広がっていますか。", ["モノの所有よりも体験そのものに価値を見出す傾向", "モノをたくさん所有する傾向", "消費を全くしない傾向", "高級品だけを買う傾向"], 0),
            ("この背景には何をきっかけとした価値観の転換がありますか。", ["限られた資源", "豊富な資源だけ", "広告の影響だけ", "流行だけ"], 0),
            ("この文章のテーマは何ですか。", ["若い世代の消費価値観の変化", "高齢者の消費行動", "企業の利益構造", "国際貿易"], 0),
        ],
    ),
    (
        "toshi_nougyou_kakushin_report",
        "Laporan tentang Inovasi dalam Pertanian Perkotaan",
        "限られたスペースを活用した都市型農業をきっかけに、食料自給"
        "率向上への期待が高まっている。技術的な課題は残るものの、"
        "地産地消の実現に向けた取り組みとして、今後の発展が注目され"
        "ている。",
        "Dengan pertanian perkotaan yang memanfaatkan ruang terbatas "
        "sebagai pemicu, harapan akan peningkatan swasembada pangan "
        "semakin meningkat. Meskipun tantangan teknis masih tersisa, "
        "perkembangan ke depan diperhatikan sebagai upaya menuju "
        "realisasi produksi-konsumsi lokal.",
        [
            ("何をきっかけに食料自給率向上への期待が高まっていますか。", ["限られたスペースを活用した都市型農業", "海外からの輸入拡大", "農地の拡大だけ", "人口減少だけ"], 0),
            ("何が残っていますか。", ["技術的な課題", "経済的な余裕だけ", "土地の余りだけ", "人材の余剰だけ"], 0),
            ("何に向けた取り組みとして注目されていますか。", ["地産地消の実現", "輸出の拡大だけ", "農業の完全廃止", "都市の消滅"], 0),
        ],
    ),
    (
        "idenshi_kagaku_dilenma_essay",
        "Esai tentang Dilema Kemajuan Genetika Manusia",
        "遺伝子技術の発展により、病気の予防や治療に大きな可能性が"
        "開かれつつあるにもかかわらず、その応用範囲をどこまで許容"
        "すべきかという倫理的な議論は追いついていない。技術の可能性"
        "と倫理的な慎重さの両立が求められている。",
        "Meskipun dengan perkembangan teknologi genetika, kemungkinan "
        "besar terbuka untuk pencegahan dan pengobatan penyakit, "
        "diskusi etika tentang sejauh mana cakupan penerapannya "
        "harus diizinkan belum sejalan. Diperlukan keseimbangan "
        "antara kemungkinan teknologi dan kehati-hatian etika.",
        [
            ("遺伝子技術の発展により何が開かれつつありますか。", ["病気の予防や治療への大きな可能性", "経済成長への可能性だけ", "人口増加への可能性", "農業への可能性だけ"], 0),
            ("何が追いついていませんか。", ["応用範囲についての倫理的な議論", "技術そのものの発展", "資金の確保だけ", "研究者の数だけ"], 0),
            ("何が求められていますか。", ["技術の可能性と倫理的な慎重さの両立", "技術開発の即時停止", "倫理の完全無視", "何もしないこと"], 0),
        ],
    ),
    (
        "seiji_leadership_rinri_essay",
        "Esai tentang Etika Kepemimpinan Politik",
        "指導者に求められる資質は時代とともに変化してきたが、権力を"
        "私利私欲のために用いないという原則だけは、いつの時代も"
        "変わらず求められてきた。この原則が形骸化している現状に、"
        "危機感を覚えずにはいられない。",
        "Kualitas yang dituntut dari seorang pemimpin telah berubah "
        "seiring zaman, tetapi hanya prinsip untuk tidak menggunakan "
        "kekuasaan demi kepentingan pribadi yang selalu dituntut "
        "tanpa berubah di setiap zaman. Saya tidak bisa menahan diri "
        "untuk merasakan krisis terhadap kondisi di mana prinsip ini "
        "menjadi formalitas belaka.",
        [
            ("指導者に求められる資質はどうしてきましたか。", ["時代とともに変化してきた", "全く変わらなかった", "誰にも求められなかった", "科学的に決められている"], 0),
            ("いつの時代も変わらず求められてきた原則は何ですか。", ["権力を私利私欲のために用いないこと", "常に人気を得ること", "たくさん話すこと", "若くあること"], 0),
            ("筆者はどんな現状に危機感を覚えていますか。", ["この原則が形骸化している現状", "指導者が多すぎる現状", "誰も政治に興味がない現状", "権力が弱すぎる現状"], 0),
        ],
    ),
    (
        "shihou_seido_kaikaku_kiji",
        "Artikel tentang Reformasi Sistem Peradilan",
        "裁判の迅速化をきっかけに導入された制度改革は一定の成果を"
        "上げているにもかかわらず、専門性の高い事件では審理の質との"
        "バランスが課題として残っている。効率と正確性の両立が引き"
        "続き問われている。",
        "Meskipun reformasi sistem yang diperkenalkan dengan "
        "percepatan persidangan sebagai pemicu menunjukkan hasil "
        "tertentu, dalam kasus yang sangat teknis, keseimbangan "
        "dengan kualitas persidangan tetap menjadi tantangan. "
        "Keseimbangan antara efisiensi dan akurasi terus "
        "dipertanyakan.",
        [
            ("何をきっかけに制度改革が導入されましたか。", ["裁判の迅速化", "裁判官の増員だけ", "法律の完全な変更", "予算の増加だけ"], 0),
            ("専門性の高い事件では何が課題として残っていますか。", ["審理の質とのバランス", "裁判官の数だけ", "費用の高さだけ", "場所の問題"], 0),
            ("何が引き続き問われていますか。", ["効率と正確性の両立", "裁判の完全廃止", "迅速化だけの追求", "正確性の放棄"], 0),
        ],
    ),
    (
        "digital_ginkou_eikyou_bunseki",
        "Analisis tentang Dampak Digitalisasi pada Sektor Perbankan",
        "オンラインバンキングの普及により店舗を訪れる顧客が減少して"
        "いるにもかかわらず、対面でのきめ細やかな相談を求める層も"
        "一定数存在し続けている。両方のニーズに応える体制構築が銀行"
        "業界の課題となっている。",
        "Meskipun jumlah pelanggan yang mengunjungi cabang menurun "
        "dengan meluasnya perbankan online, ada juga sejumlah "
        "lapisan yang terus menuntut konsultasi tatap muka yang "
        "teliti. Membangun sistem yang memenuhi kedua kebutuhan "
        "menjadi tantangan industri perbankan.",
        [
            ("何の普及により店舗を訪れる顧客が減少していますか。", ["オンラインバンキング", "現金決済", "対面サービス", "紙の通帳"], 0),
            ("どんな層が一定数存在し続けていますか。", ["対面でのきめ細やかな相談を求める層", "オンラインだけを求める層", "銀行を全く使わない層", "現金だけを使う層"], 0),
            ("銀行業界の課題は何ですか。", ["両方のニーズに応える体制構築", "店舗の完全廃止", "オンラインの廃止", "顧客の削減"], 0),
        ],
    ),
    (
        "remote_work_pandemic_go_report",
        "Laporan tentang Perubahan Pola Kerja Jarak Jauh Pasca Pandemi",
        "パンデミックが収束した後もリモートワークを継続する企業が"
        "一定数残っているにもかかわらず、完全に元のオフィス勤務体制"
        "に戻す企業も少なくない。働き方の最適解は、業種や企業文化に"
        "よって大きく異なるようだ。",
        "Meskipun ada sejumlah perusahaan yang tetap melanjutkan "
        "kerja jarak jauh setelah pandemi mereda, tidak sedikit juga "
        "perusahaan yang kembali sepenuhnya ke sistem kerja kantor. "
        "Sepertinya solusi optimal cara kerja sangat berbeda "
        "tergantung industri dan budaya perusahaan.",
        [
            ("パンデミックが収束した後、どんな企業が一定数残っていますか。", ["リモートワークを継続する企業", "全ての社員を解雇する企業", "事業を停止する企業", "海外に移転する企業"], 0),
            ("何をする企業も少なくありませんか。", ["完全に元のオフィス勤務体制に戻すこと", "リモートワークを義務化すること", "会社を閉鎖すること", "給料を増やすことだけ"], 0),
            ("働き方の最適解は何によって大きく異なるようですか。", ["業種や企業文化", "社員の年齢だけ", "会社の場所だけ", "社長の性格だけ"], 0),
        ],
    ),
    (
        "kagaku_shinrai_koukyou_editorial",
        "Editorial tentang Krisis Kepercayaan terhadap Sains Publik",
        "科学的知見が政策決定の根拠として重視される一方で、専門家へ"
        "の不信感を背景に、科学的合意そのものを疑問視する声も強まっ"
        "ているにもかかわらず、この分断を埋める建設的な対話は十分に"
        "行われていない。",
        "Sementara pengetahuan ilmiah dipentingkan sebagai dasar "
        "pengambilan kebijakan, meskipun suara yang mempertanyakan "
        "konsensus ilmiah itu sendiri juga semakin kuat dengan latar "
        "belakang ketidakpercayaan pada ahli, dialog konstruktif "
        "untuk mengisi perpecahan ini belum cukup dilakukan.",
        [
            ("科学的知見はどう重視されていますか。", ["政策決定の根拠として", "娯楽として", "経済成長の道具として", "無視すべきものとして"], 0),
            ("何を背景に科学的合意を疑問視する声が強まっていますか。", ["専門家への不信感", "科学の進歩の速さ", "予算の不足だけ", "国際競争だけ"], 0),
            ("何が十分に行われていませんか。", ["この分断を埋める建設的な対話", "科学研究そのもの", "政策決定だけ", "専門家の育成だけ"], 0),
        ],
    ),
    (
        "gakumon_jiyuu_genkai_essay",
        "Esai tentang Batas Kebebasan Akademik",
        "学問の自由は真理探究の根幹をなす原則であるにもかかわらず、"
        "社会的な影響が大きい研究テーマについては、一定の倫理的配慮"
        "も同時に求められる。自由と責任の境界線を引くことの難しさ"
        "を、改めて感じさせられる。",
        "Meskipun kebebasan akademik adalah prinsip yang menjadi "
        "dasar pencarian kebenaran, untuk tema penelitian dengan "
        "dampak sosial besar, kepedulian etika tertentu juga "
        "dituntut secara bersamaan. Kembali dirasakan kesulitan "
        "menarik garis batas antara kebebasan dan tanggung jawab.",
        [
            ("学問の自由はどんな原則ですか。", ["真理探究の根幹をなす原則", "誰も守らない原則", "無制限の原則", "新しい原則"], 0),
            ("社会的な影響が大きい研究テーマには何が求められますか。", ["一定の倫理的配慮", "完全な自由だけ", "研究の中止だけ", "無制限の資金"], 0),
            ("何の難しさを改めて感じさせられますか。", ["自由と責任の境界線を引くこと", "研究資金を集めること", "論文を書くこと", "学生を教えること"], 0),
        ],
    ),
    (
        "kikou_tekiou_toshi_kadai_kiji",
        "Artikel tentang Tantangan Adaptasi Iklim di Perkotaan",
        "都市部における猛暑対策をきっかけに緑地整備への投資が拡大"
        "しているにもかかわらず、財政的な制約から抜本的な対策には"
        "至っていない自治体も多い。長期的な視点に立った計画的な投資"
        "が求められている。",
        "Meskipun investasi pada penataan lahan hijau meluas dengan "
        "langkah-langkah mengatasi panas ekstrem di perkotaan "
        "sebagai pemicu, banyak juga pemerintah daerah yang belum "
        "mencapai langkah mendasar karena keterbatasan anggaran. "
        "Diperlukan investasi terencana dari sudut pandang jangka "
        "panjang.",
        [
            ("何をきっかけに緑地整備への投資が拡大していますか。", ["都市部における猛暑対策", "人口増加", "観光振興だけ", "経済成長だけ"], 0),
            ("何から抜本的な対策に至っていない自治体が多いですか。", ["財政的な制約", "住民の反対だけ", "技術の不足だけ", "時間の不足だけ"], 0),
            ("何が求められていますか。", ["長期的な視点に立った計画的な投資", "短期的な対策だけ", "投資の完全停止", "緑地の削減"], 0),
        ],
    ),
    (
        "kachikan_shouhi_alpha_bunseki",
        "Analisis tentang Perubahan Nilai Karier Generasi Alpha",
        "まだ幼いアルファ世代だが、既存の職業観に縛られない多様な"
        "キャリア観を持つ可能性が指摘されている。デジタルネイティブ"
        "として育つ環境が、将来的な働き方の選択にどう影響するか、"
        "今後の分析が待たれる。",
        "Meskipun Generasi Alpha masih muda, kemungkinan memiliki "
        "pandangan karier yang beragam yang tidak terikat pandangan "
        "pekerjaan tradisional ditunjukkan. Bagaimana lingkungan "
        "tumbuh sebagai digital native mempengaruhi pilihan cara "
        "kerja di masa depan, analisis ke depan dinantikan.",
        [
            ("アルファ世代についてどんな可能性が指摘されていますか。", ["既存の職業観に縛られない多様なキャリア観を持つ可能性", "伝統的な職業観だけを持つ可能性", "働くことに興味がない可能性", "誰も働かなくなる可能性"], 0),
            ("アルファ世代はどんな環境で育ちますか。", ["デジタルネイティブとして育つ環境", "アナログな環境だけ", "孤立した環境", "農村の環境だけ"], 0),
            ("何が待たれていますか。", ["今後の分析", "即座の結論", "調査の中止", "過去のデータだけ"], 0),
        ],
    ),
    (
        "umi_energy_kakushin_report",
        "Laporan tentang Inovasi dalam Energi Terbarukan Laut",
        "波力や潮力を活用した海洋エネルギーをきっかけに、新たな再生"
        "可能エネルギー源への期待が高まっている。技術的にはまだ発展"
        "途上であるものの、島国という地理的条件を生かした分野として"
        "注目されている。",
        "Dengan energi laut yang memanfaatkan tenaga gelombang dan "
        "pasang surut sebagai pemicu, harapan terhadap sumber energi "
        "terbarukan baru semakin meningkat. Meskipun secara teknis "
        "masih dalam pengembangan, diperhatikan sebagai bidang yang "
        "memanfaatkan kondisi geografis negara kepulauan.",
        [
            ("何をきっかけに新たな再生可能エネルギー源への期待が高まっていますか。", ["波力や潮力を活用した海洋エネルギー", "石油の増産", "原子力発電の拡大", "石炭の利用拡大"], 0),
            ("技術的にはどうですか。", ["まだ発展途上", "完全に完成している", "全く進んでいない", "不可能である"], 0),
            ("どんな地理的条件を生かした分野として注目されていますか。", ["島国", "内陸国", "砂漠地帯", "極地"], 0),
        ],
    ),
    (
        "ai_geijutsu_dilenma_essay",
        "Esai tentang Dilema Kecerdasan Buatan dalam Seni",
        "AIによる創作物が人間の作品と見分けがつかないレベルに達し"
        "つつあるにもかかわらず、創造性の本質は人間固有のものだと"
        "いう見方も根強い。芸術における「作者性」の概念そのものが、"
        "問い直しを迫られているのかもしれない。",
        "Meskipun karya buatan AI mencapai tingkat yang tidak bisa "
        "dibedakan dari karya manusia, pandangan bahwa esensi "
        "kreativitas adalah sesuatu yang unik bagi manusia juga kuat "
        "bertahan. Konsep \"kepengarangan\" dalam seni itu sendiri "
        "mungkin dituntut untuk dipertanyakan kembali.",
        [
            ("AIによる創作物はどんなレベルに達しつつありますか。", ["人間の作品と見分けがつかないレベル", "全く価値のないレベル", "人間より劣るレベルだけ", "誰も評価しないレベル"], 0),
            ("どんな見方が根強いですか。", ["創造性の本質は人間固有のものだという見方", "AIの方が優れているという見方", "芸術は不要だという見方", "誰も気にしないという見方"], 0),
            ("何が問い直しを迫られているのかもしれませんか。", ["芸術における「作者性」の概念", "AI技術そのもの", "芸術の値段", "美術館の役割"], 0),
        ],
    ),
]
...
N1_ENTRIES = [
    ...
    (
        "seijitsu_imi_reflection",
        "Refleksi tentang Makna Kesetiaan",
        "誠実であるということは、単に約束を守ることだけを意味するの"
        "ではない。時に自分にとって不利益であっても、信じた道を貫こ"
        "うとする姿勢そのものにこそ、誠実さの本質が宿っているのでは"
        "ないかと思わずにはいられない。",
        "Menjadi setia bukan hanya berarti sekadar menepati janji. "
        "Saya tidak bisa menahan diri untuk berpikir bahwa justru "
        "dalam sikap untuk terus menempuh jalan yang diyakini, "
        "bahkan ketika itu merugikan diri sendiri, esensi kesetiaan "
        "itu bersemayam.",
        [
            ("誠実であるということは何だけを意味するのではありませんか。", ["単に約束を守ること", "裏切ること", "嘘をつくこと", "何もしないこと"], 0),
            ("筆者は誠実さの本質がどこに宿っていると考えていますか。", ["信じた道を貫こうとする姿勢そのもの", "利益を優先する姿勢", "誰にも従う姿勢", "何もしない姿勢"], 0),
            ("筆者は何を思わずにはいられませんか。", ["誠実さの本質についての考え", "誠実さは不要だということ", "約束は無意味だということ", "誰も誠実ではないということ"], 0),
        ],
    ),
    (
        "kazoku_isan_omoni_essay",
        "Esai tentang Beban Menjaga Warisan Keluarga",
        "先祖代々受け継がれてきたものを守り続けることには、想像以上"
        "の重圧が伴う。それを次の世代へ引き継ぐべきか、それとも新た"
        "な道を選ぶべきか、その選択の重さに、幾度となく心を揺さぶら"
        "れずにはいられなかった。",
        "Terus menjaga sesuatu yang diwariskan turun-temurun dari "
        "leluhur membawa tekanan yang lebih besar dari bayangan. "
        "Apakah harus meneruskannya ke generasi berikutnya, atau "
        "memilih jalan baru — berkali-kali hati saya tidak bisa "
        "menahan diri untuk tergoncang oleh beratnya pilihan itu.",
        [
            ("先祖代々受け継がれてきたものを守り続けることには何が伴いますか。", ["想像以上の重圧", "何の負担もないこと", "楽しさだけ", "お金だけ"], 0),
            ("筆者はどんな選択に迫られていますか。", ["次の世代へ引き継ぐか新たな道を選ぶか", "誰と結婚するか", "どこに住むか", "何を食べるか"], 0),
            ("筆者の心はどうなりましたか。", ["幾度となく揺さぶられずにはいられなかった", "全く動じなかった", "すぐに答えが出た", "何も感じなかった"], 0),
        ],
    ),
    (
        "shukan_shinjitsu_kyoukai_tetsugaku",
        "Diskusi Filosofis tentang Batas Kebenaran Subjektif",
        "客観的な真実など存在せず、あるのは無数の主観的な解釈のみだ"
        "という立場がある。しかし、その立場を突き詰めれば、あらゆる"
        "主張が等しく正しいということになりかねず、その帰結には慎重"
        "にならざるを得ない。",
        "Ada pandangan bahwa kebenaran objektif tidak ada, yang ada "
        "hanyalah interpretasi subjektif yang tak terhitung jumlahnya. "
        "Namun, jika pandangan itu ditelusuri sampai ke akarnya, bisa "
        "berujung pada semua klaim dianggap sama-sama benar, dan "
        "terhadap konsekuensi itu, mau tidak mau harus berhati-hati.",
        [
            ("どんな立場がありますか。", ["客観的な真実は存在せず主観的な解釈のみだという立場", "客観的な真実だけが存在するという立場", "真実は誰にでも同じだという立場", "真実は科学だけが決めるという立場"], 0),
            ("その立場を突き詰めるとどうなりかねませんか。", ["あらゆる主張が等しく正しいということになる", "一つの真実だけが残る", "誰も何も主張できなくなる", "科学が全て解決する"], 0),
            ("筆者はその帰結にどう向き合っていますか。", ["慎重にならざるを得ない", "全く気にしない", "すぐに受け入れる", "無視する"], 0),
        ],
    ),
    (
        "kanso_bigaku_hihyou",
        "Kritik tentang Estetika Kesederhanaan",
        "装飾を削ぎ落とした簡素な美しさは、時に豪華絢爛な美よりも"
        "深い余韻を残す。何も足さないことの難しさゆえに、簡素さを"
        "追求する道こそが、真に成熟した美意識の表れなのかもしれない。",
        "Keindahan sederhana yang telah menghilangkan dekorasi "
        "terkadang meninggalkan gema yang lebih dalam daripada "
        "keindahan yang mewah dan megah. Karena sulitnya tidak "
        "menambahkan apa pun, jalan mengejar kesederhanaan itulah "
        "mungkin wujud kesadaran estetika yang benar-benar matang.",
        [
            ("装飾を削ぎ落とした簡素な美しさは何を残すことがありますか。", ["豪華絢爛な美よりも深い余韻", "何の印象も残らないこと", "浅い印象だけ", "混乱だけ"], 0),
            ("何ゆえに簡素さを追求する道が真に成熟した美意識の表れかもしれませんか。", ["何も足さないことの難しさ", "装飾の多さ", "値段の高さ", "時間の短さ"], 0),
            ("この文章は何について述べていますか。", ["簡素さの美学", "豪華さの重要性", "装飾の必要性", "流行の美"], 0),
        ],
    ),
    (
        "kikyou_imi_reflection",
        "Refleksi tentang Arti Kepulangan",
        "長い旅の果てに帰る場所があるということは、当たり前のようで"
        "いて、決して当たり前ではない。帰る場所があるからこそ人は前"
        "へ進む勇気を持てるのだと、離れて初めて気づかされることが"
        "多い。",
        "Adanya tempat untuk pulang setelah perjalanan panjang, "
        "meskipun terkesan wajar, sesungguhnya sama sekali tidak "
        "wajar. Justru karena ada tempat untuk pulang, manusia bisa "
        "memiliki keberanian untuk maju ke depan — banyak yang baru "
        "disadari setelah pergi jauh.",
        [
            ("長い旅の果てに帰る場所があるということはどんなことですか。", ["当たり前のようで決して当たり前ではないこと", "誰にとっても簡単なこと", "何の意味もないこと", "誰にでも同じこと"], 0),
            ("人は何があるから前へ進む勇気を持てますか。", ["帰る場所", "お金", "名声", "力"], 0),
            ("いつこのことに気づかされることが多いですか。", ["離れて初めて", "すぐに", "子供の頃から", "一度も気づかない"], 0),
        ],
    ),
    (
        "shakai_shinpo_hiniku_n1_2",
        "Esai tentang Ironi Kemajuan Sosial",
        "社会制度は絶えず改善されてきたはずであるにもかかわらず、"
        "人々が感じる生きづらさは、必ずしも軽減されているとは言えな"
        "い。制度の整備だけでは満たされない、何か別の要素が存在する"
        "のかもしれない。",
        "Meskipun sistem sosial seharusnya terus diperbaiki, kesulitan "
        "hidup yang dirasakan orang belum tentu bisa dikatakan "
        "berkurang. Mungkin ada elemen lain yang tidak bisa terpenuhi "
        "hanya dengan penataan sistem.",
        [
            ("社会制度はどうであったはずですか。", ["絶えず改善されてきたはず", "全く変わらなかったはず", "悪化し続けたはず", "誰も気にしなかったはず"], 0),
            ("人々が感じる生きづらさはどうですか。", ["必ずしも軽減されているとは言えない", "完全になくなった", "以前よりずっと楽になった", "誰も感じていない"], 0),
            ("筆者は何が存在するのかもしれないと述べていますか。", ["制度の整備だけでは満たされない別の要素", "制度そのものの不要さ", "人々の怠惰さだけ", "何も存在しないこと"], 0),
        ],
    ),
    (
        "yume_genjitsu_kyoukai_discussion",
        "Diskusi tentang Batas Antara Mimpi dan Kenyataan",
        "人が心の底から望むものは、現実の制約によって諦めざるを得な"
        "いことが多い。しかし、その諦めきれなかった思いこそが、時に"
        "人生を動かす原動力になることもあるのではないだろうか。",
        "Apa yang benar-benar diinginkan seseorang dari dasar hatinya, "
        "seringkali harus dilepaskan karena keterbatasan kenyataan. "
        "Namun, bukankah justru perasaan yang tidak bisa sepenuhnya "
        "dilepaskan itulah yang terkadang menjadi penggerak "
        "kehidupan?",
        [
            ("人が心の底から望むものはどうなることが多いですか。", ["現実の制約によって諦めざるを得ない", "簡単に実現する", "すぐに忘れられる", "誰にも理解されない"], 0),
            ("筆者は何が人生を動かす原動力になることもあると考えていますか。", ["諦めきれなかった思い", "完全に諦めた思い", "お金への欲望だけ", "他人への嫉妬だけ"], 0),
            ("この文章は何について論じていますか。", ["夢と現実の関係", "仕事の効率", "健康法", "経済政策"], 0),
        ],
    ),
    (
        "chinmoku_isan_hikitsugu_reflection",
        "Refleksi tentang Warisan Diam yang Diwariskan",
        "親から子へと受け継がれるものの中には、言葉で語られることの"
        "ない、態度や生き方そのものが含まれている。教えられずとも"
        "自然と身についた価値観こそ、最も深く根を張った遺産なのかも"
        "しれない。",
        "Di antara hal-hal yang diwariskan dari orang tua ke anak, "
        "termasuk sikap dan cara hidup itu sendiri yang tidak pernah "
        "diceritakan dengan kata-kata. Nilai yang terpasang secara "
        "alami tanpa diajarkan itulah mungkin warisan yang paling "
        "dalam berakar.",
        [
            ("親から子へと受け継がれるものの中には何が含まれていますか。", ["言葉で語られることのない態度や生き方そのもの", "お金だけ", "知識だけ", "名前だけ"], 0),
            ("教えられずとも自然と身についたものは何かもしれませんか。", ["最も深く根を張った遺産", "無意味なもの", "忘れるべきもの", "表面的なものだけ"], 0),
            ("この文章のテーマは何ですか。", ["言葉にならない世代間の継承", "お金の相続", "教育制度", "法律"], 0),
        ],
    ),
    (
        "kodoku_taeru_tsuyosa_essay",
        "Esai tentang Ketahanan dalam Menghadapi Kesepian",
        "孤独を単なる欠如として捉えるのではなく、自己と深く向き合う"
        "ための貴重な時間として受け止め直すことはできないだろうか。"
        "誰にも頼れない状況にこそ、真の自分と出会う機会が潜んでいる"
        "ように思えてならない。",
        "Bukankah bisa mempertimbangkan kembali kesepian bukan sekadar "
        "sebagai kekurangan, melainkan sebagai waktu berharga untuk "
        "menghadapi diri sendiri secara mendalam? Saya merasa tidak "
        "bisa menahan diri untuk berpikir bahwa justru dalam situasi "
        "tidak bisa bergantung pada siapa pun itulah tersembunyi "
        "kesempatan bertemu dengan diri sejati.",
        [
            ("筆者は孤独をどう捉え直せないかと問いかけていますか。", ["自己と深く向き合うための貴重な時間として", "単なる不幸として", "避けるべき欠如として", "誰にとっても悪いものとして"], 0),
            ("何にこそ真の自分と出会う機会が潜んでいるように思えますか。", ["誰にも頼れない状況", "誰かに頼れる状況", "忙しい状況", "楽しい状況だけ"], 0),
            ("この文章のテーマは何ですか。", ["孤独の再解釈", "友情の重要性", "仕事の効率", "健康法"], 0),
        ],
    ),
    (
        "kanzen_koufuku_shinwa_hihyou",
        "Kritik tentang Mitos Kebahagiaan Sempurna",
        "一切の悩みも痛みもない完全な幸福というものは、そもそも幻想"
        "に過ぎないのかもしれない。むしろ、悲しみや葛藤を含んだ人生"
        "の複雑さをそのまま受け入れることこそが、成熟した幸福のあり"
        "方なのではないだろうか。",
        "Kebahagiaan sempurna tanpa kekhawatiran atau rasa sakit sama "
        "sekali, mungkin sejak awal hanyalah ilusi belaka. Bukankah "
        "justru menerima apa adanya kompleksitas hidup yang mengandung "
        "kesedihan dan konflik itulah bentuk kebahagiaan yang matang?",
        [
            ("一切の悩みも痛みもない完全な幸福とは何かもしれませんか。", ["幻想に過ぎないもの", "誰もが持っているもの", "簡単に得られるもの", "科学で証明されたもの"], 0),
            ("筆者は何を受け入れることが成熟した幸福のあり方だと考えていますか。", ["悲しみや葛藤を含んだ人生の複雑さ", "完全に悩みのない生活", "他人との比較だけ", "お金による幸福だけ"], 0),
            ("この文章のテーマは何ですか。", ["幸福の本質についての再考", "お金の使い方", "健康の維持法", "仕事の選び方"], 0),
        ],
    ),
    (
        "machiitsuzukeru_imi_reflection",
        "Refleksi tentang Makna Menunggu Tanpa Kepastian",
        "いつ終わるとも知れない待機の時間ほど、人の心をすり減らす"
        "ものはない。それでも、確実性を欠いたまま何かを待ち続けると"
        "いう行為の中にこそ、人間らしい忍耐の本質が宿っているように"
        "思えてならない。",
        "Tidak ada yang lebih menggerus hati manusia daripada waktu "
        "menunggu yang tidak diketahui kapan berakhirnya. Meski "
        "begitu, saya merasa tidak bisa menahan diri untuk berpikir "
        "bahwa justru di dalam tindakan terus menunggu sesuatu tanpa "
        "kepastian itulah esensi kesabaran yang manusiawi bersemayam.",
        [
            ("いつ終わるとも知れない待機の時間はどうだと述べられていますか。", ["人の心をすり減らすもの", "人を強くするだけのもの", "何の影響もないもの", "楽しいもの"], 0),
            ("筆者は何の本質が宿っていると思えてならないと述べていますか。", ["人間らしい忍耐の本質", "諦めの本質", "怠惰の本質", "無関心の本質"], 0),
            ("この文章のテーマは何ですか。", ["不確実な待機の意味", "効率的な時間管理", "健康法", "人間関係の築き方"], 0),
        ],
    ),
    (
        "koutsugisha_omoni_essay",
        "Esai tentang Beban Menjadi Penerus Tunggal",
        "一族の中でただ一人の後継者として期待を背負うことには、想像"
        "を超えた孤独が伴う。誰にも打ち明けられない重圧を抱えながら"
        "も、その役割を引き受けようとする姿勢に、静かな尊さを感じず"
        "にはいられない。",
        "Memikul harapan sebagai satu-satunya pewaris dalam keluarga "
        "besar membawa kesepian yang melampaui bayangan. Saya tidak "
        "bisa menahan diri untuk merasakan keluhuran yang tenang "
        "dalam sikap yang tetap berusaha menerima peran itu, meski "
        "memikul tekanan yang tidak bisa diungkapkan kepada siapa "
        "pun.",
        [
            ("一族の中でただ一人の後継者として期待を背負うことには何が伴いますか。", ["想像を超えた孤独", "楽しさだけ", "経済的な豊かさだけ", "何の負担もないこと"], 0),
            ("どんな重圧を抱えていますか。", ["誰にも打ち明けられない重圧", "誰もが知っている重圧", "軽い重圧", "存在しない重圧"], 0),
            ("筆者は何に静かな尊さを感じずにはいられませんか。", ["その役割を引き受けようとする姿勢", "役割を拒否する姿勢", "何もしない姿勢", "逃げる姿勢"], 0),
        ],
    ),
    (
        "jiga_kyoukai_tetsugaku",
        "Diskusi Filosofis tentang Batas Identitas Diri",
        "自己とは、他者との関係性の中で絶えず再定義され続ける、流動"
        "的な構築物にすぎないのかもしれない。固定された「本当の自分」"
        "という概念そのものが、幻想にすぎないという可能性を、真剣に"
        "検討せざるを得ない。",
        "Diri mungkin hanyalah konstruksi yang cair, yang "
        "terus-menerus didefinisikan ulang dalam hubungan dengan "
        "orang lain. Mau tidak mau harus mempertimbangkan secara "
        "serius kemungkinan bahwa konsep \"diri sejati\" yang tetap "
        "itu sendiri hanyalah ilusi.",
        [
            ("自己とは何かもしれないと述べられていますか。", ["他者との関係性の中で絶えず再定義され続ける流動的な構築物", "絶対に変わらない固定されたもの", "誰にとっても同じもの", "科学的に証明されたもの"], 0),
            ("何が幻想にすぎない可能性がありますか。", ["固定された「本当の自分」という概念", "他者との関係性", "社会そのもの", "言葉そのもの"], 0),
            ("筆者はこの可能性をどう検討していますか。", ["真剣に検討せざるを得ない", "全く無視する", "すぐに否定する", "気にしない"], 0),
        ],
    ),
    (
        "fuhensei_bigaku_hihyou",
        "Kritik tentang Estetika Ketidakabadian",
        "咲いてはすぐに散る桜が古来より愛されてきたのは、その儚さ"
        "ゆえだと言われる。永遠に続くものよりも、いずれ消えゆくと"
        "分かっているものにこそ、人は美しさを見出さずにはいられない"
        "のかもしれない。",
        "Dikatakan bahwa bunga sakura yang mekar lalu segera gugur "
        "telah dicintai sejak zaman kuno karena kefanaannya. Manusia "
        "mungkin tidak bisa menahan diri untuk menemukan keindahan "
        "justru pada sesuatu yang diketahui akan lenyap, dibandingkan "
        "sesuatu yang berlangsung selamanya.",
        [
            ("桜が古来より愛されてきたのはなぜだと言われていますか。", ["その儚さゆえ", "その永遠さゆえ", "その値段の高さゆえ", "その珍しさゆえ"], 0),
            ("人は何に美しさを見出さずにはいられないのかもしれませんか。", ["いずれ消えゆくと分かっているもの", "永遠に続くものだけ", "高価なものだけ", "誰もが持っているもの"], 0),
            ("この文章のテーマは何ですか。", ["儚さの美学", "永続性の価値", "経済的な価値", "科学的な分析"], 0),
        ],
    ),
    (
        "bokokugo_soushitsu_reflection",
        "Refleksi tentang Arti Kehilangan Bahasa Ibu",
        "異国で長く暮らすうちに、母語で微妙な感情を表現することが"
        "難しくなっていく自分に気づくことがある。言葉を失うという"
        "ことは、単なる語彙の減少ではなく、自己の一部を失うことに"
        "等しいのかもしれない。",
        "Seiring lama tinggal di negeri asing, terkadang menyadari "
        "diri sendiri menjadi sulit mengungkapkan perasaan halus "
        "dalam bahasa ibu. Kehilangan bahasa mungkin bukan sekadar "
        "penurunan kosakata, melainkan setara dengan kehilangan "
        "sebagian dari diri sendiri.",
        [
            ("異国で長く暮らすうちに何に気づくことがありますか。", ["母語で微妙な感情を表現することが難しくなっていくこと", "外国語がもっと簡単になること", "母語を完全に忘れること", "何も変わらないこと"], 0),
            ("言葉を失うということは何に等しいかもしれませんか。", ["自己の一部を失うこと", "単なる不便さ", "新しい機会", "何の意味もないこと"], 0),
            ("この文章のテーマは何ですか。", ["母語喪失と自己の関係", "外国語学習の方法", "異文化交流の楽しさ", "翻訳の技術"], 0),
        ],
    ),
    (
        "tsuushin_shinpo_hiniku_n1_3",
        "Esai tentang Ironi Kemajuan Komunikasi",
        "通信技術の発達により、地球の裏側にいる人とも瞬時につながれ"
        "るようになったにもかかわらず、隣にいる人との対話は、かえっ"
        "て希薄になっているように感じられることがある。つながりの量"
        "と深さは、必ずしも比例しないのかもしれない。",
        "Meskipun dengan perkembangan teknologi komunikasi, kita "
        "bisa terhubung seketika dengan orang di belahan bumi lain, "
        "terkadang terasa bahwa dialog dengan orang di sebelah kita "
        "justru menjadi lebih tipis. Kuantitas dan kedalaman koneksi "
        "mungkin tidak selalu berbanding lurus.",
        [
            ("通信技術の発達により何が可能になりましたか。", ["地球の裏側にいる人とも瞬時につながれること", "誰とも話せなくなること", "技術が全て消えること", "孤独がなくなること"], 0),
            ("隣にいる人との対話はどう感じられることがありますか。", ["かえって希薄になっている", "もっと深くなっている", "全く変わらない", "完全になくなった"], 0),
            ("筆者は何が必ずしも比例しないのかもしれないと述べていますか。", ["つながりの量と深さ", "技術と幸福", "お金と時間", "過去と未来だけ"], 0),
        ],
    ),
    (
        "kioku_souzou_kyoukai_discussion",
        "Diskusi tentang Batas Antara Ingatan dan Rekaan",
        "過去の記憶とは、実際に起きた出来事の忠実な記録ではなく、"
        "その時々の心理状態によって無意識に書き換えられた、一種の"
        "物語なのかもしれない。純粋な事実としての過去など、そもそも"
        "存在しないのではないだろうか。",
        "Kenangan masa lalu mungkin bukan catatan setia dari "
        "kejadian yang benar-benar terjadi, melainkan semacam narasi "
        "yang secara tidak sadar ditulis ulang sesuai kondisi "
        "psikologis saat itu. Bukankah masa lalu sebagai fakta murni "
        "sejak awal memang tidak ada?",
        [
            ("過去の記憶とは何かもしれないと述べられていますか。", ["心理状態によって無意識に書き換えられた一種の物語", "実際に起きた出来事の忠実な記録", "完全に正確なデータ", "誰にとっても同じもの"], 0),
            ("何がそもそも存在しないのではないかと問いかけられていますか。", ["純粋な事実としての過去", "記憶そのもの", "感情そのもの", "時間そのもの"], 0),
            ("この文章のテーマは何ですか。", ["記憶と物語の境界", "歴史学の方法論", "心理学の実験結果", "脳科学の発見"], 0),
        ],
    ),
    (
        "kizu_isan_kakushi_reflection",
        "Refleksi tentang Warisan Luka yang Tersembunyi",
        "家族の中には、決して口にされることのない傷が、静かに世代を"
        "超えて受け継がれていくことがある。語られなかったことその"
        "ものが、次の世代の無意識の中に、消えない痕跡として刻まれて"
        "いるのかもしれない。",
        "Dalam keluarga, terkadang ada luka yang tidak pernah "
        "diucapkan, secara diam-diam diwariskan melampaui generasi. "
        "Hal yang tidak pernah diceritakan itu sendiri, mungkin "
        "terukir sebagai jejak yang tak terhapuskan di dalam alam "
        "bawah sadar generasi berikutnya.",
        [
            ("家族の中で何が静かに世代を超えて受け継がれていくことがありますか。", ["決して口にされることのない傷", "楽しい思い出だけ", "お金だけ", "名前だけ"], 0),
            ("何が次の世代の無意識の中に刻まれているのかもしれませんか。", ["語られなかったことそのもの", "語られたことだけ", "忘れられたことだけ", "記録されたことだけ"], 0),
            ("この文章のテーマは何ですか。", ["世代間で継承される沈黙の傷", "家族の楽しい歴史", "遺産相続の手続き", "心理療法の方法"], 0),
        ],
    ),
    (
        "futashika_taeru_tsuyosa_essay",
        "Esai tentang Ketahanan dalam Menghadapi Ketidakpastian",
        "先の見えない状況に置かれたとき、人は答えを急いで求めようと"
        "しがちだ。しかし、明確な答えのないまま宙づりの状態に耐え"
        "続けることもまた、一つの強さなのではないだろうか。全てを"
        "解決しようとする姿勢だけが、成熟の証ではない。",
        "Ketika berada dalam situasi yang tidak terlihat ke "
        "depannya, manusia cenderung terburu-buru mencari jawaban. "
        "Namun, bukankah terus bertahan dalam keadaan menggantung "
        "tanpa jawaban yang jelas pun adalah salah satu bentuk "
        "kekuatan? Bukan hanya sikap berusaha menyelesaikan "
        "segalanya yang menjadi bukti kematangan.",
        [
            ("先の見えない状況に置かれたとき、人はどうしがちですか。", ["答えを急いで求めようとする", "何もしようとしない", "すぐに諦める", "他人に頼る"], 0),
            ("筆者は何が一つの強さなのではないかと述べていますか。", ["明確な答えのないまま宙づりの状態に耐え続けること", "すぐに答えを見つけること", "問題を無視すること", "逃げること"], 0),
            ("筆者は何だけが成熟の証ではないと考えていますか。", ["全てを解決しようとする姿勢", "何もしない姿勢", "逃げる姿勢", "諦める姿勢"], 0),
        ],
    ),
    (
        "ai_kanzensei_shinwa_hihyou",
        "Kritik tentang Mitos Kesempurnaan Cinta",
        "運命の相手さえ見つければ全てがうまくいくという恋愛観は、"
        "現実の複雑さを覆い隠す甘い幻想にすぎないのかもしれない。"
        "むしろ、不完全な二人が互いの欠点を受け入れながら関係を築い"
        "ていく過程にこそ、愛の本質があるのではないだろうか。",
        "Pandangan cinta bahwa segalanya akan berjalan lancar "
        "asalkan menemukan pasangan takdir, mungkin hanyalah ilusi "
        "manis yang menutupi kompleksitas kenyataan. Bukankah justru "
        "dalam proses dua orang yang tidak sempurna membangun "
        "hubungan sambil saling menerima kekurangan masing-masing "
        "itulah terletak esensi cinta?",
        [
            ("運命の相手さえ見つければ全てがうまくいくという恋愛観は何かもしれませんか。", ["現実の複雑さを覆い隠す甘い幻想", "科学的に証明された事実", "誰にでも当てはまる真実", "最も現実的な考え方"], 0),
            ("筆者は愛の本質がどこにあるのではないかと考えていますか。", ["不完全な二人が互いの欠点を受け入れながら関係を築いていく過程", "運命の相手を見つけること自体", "完璧な相手を探し続けること", "恋愛を避けること"], 0),
            ("この文章のテーマは何ですか。", ["恋愛観の再考", "結婚の手続き", "経済的な安定", "友情の重要性"], 0),
        ],
    ),
    (
        "sonzai_kanjiru_imi_reflection",
        "Refleksi tentang Makna Kehadiran",
        "誰かがそこにいるというだけで、言葉を交わさずとも安心を感じ"
        "ることがある。存在そのものが持つ力は、言語化された慰めより"
        "も、時にはるかに深く人の心に届くのかもしれない。",
        "Terkadang hanya dengan seseorang berada di sana, tanpa "
        "bertukar kata pun bisa merasakan ketenangan. Kekuatan yang "
        "dimiliki oleh kehadiran itu sendiri, terkadang mungkin jauh "
        "lebih dalam menyentuh hati manusia daripada penghiburan "
        "yang diucapkan dengan kata-kata.",
        [
            ("誰かがそこにいるというだけで何を感じることがありますか。", ["安心", "不安", "退屈", "怒り"], 0),
            ("存在そのものが持つ力は何より深く人の心に届くかもしれませんか。", ["言語化された慰め", "お金", "時間", "距離"], 0),
            ("この文章のテーマは何ですか。", ["存在の力", "言葉の技術", "時間の使い方", "経済的な安定"], 0),
        ],
    ),
    (
        "koe_daibensha_omoni_essay",
        "Esai tentang Beban Menjadi Suara bagi yang Terdiam",
        "自ら声を上げることのできない者の代弁者を務めることには、"
        "大きな責任が伴う。誤って自分の思いを相手の声として語って"
        "しまう危うさと常に隣り合わせであることを、忘れてはならない。",
        "Bertindak sebagai juru bicara bagi orang yang tidak bisa "
        "menyuarakan sendiri membawa tanggung jawab besar. Tidak "
        "boleh dilupakan bahwa selalu berdampingan dengan bahaya "
        "secara keliru menyampaikan pikiran sendiri sebagai suara "
        "orang lain.",
        [
            ("自ら声を上げることのできない者の代弁者を務めることには何が伴いますか。", ["大きな責任", "何の責任もないこと", "楽しさだけ", "経済的な利益だけ"], 0),
            ("常に隣り合わせである危うさとは何ですか。", ["自分の思いを相手の声として語ってしまうこと", "何も話さないこと", "相手を無視すること", "声を上げないこと"], 0),
            ("この文章のテーマは何ですか。", ["代弁の責任と危うさ", "言語学の理論", "政治活動の方法", "メディアの技術"], 0),
        ],
    ),
    (
        "kentai_unmei_kyoukai_tetsugaku",
        "Diskusi Filosofis tentang Batas Kehendak dan Takdir",
        "自らの意志で選び取ったと信じている選択の多くが、実は環境や"
        "偶然に大きく規定されているのではないかという疑いを、完全に"
        "払拭することはできない。自由意志と運命の境界線は、思うより"
        "もずっと曖昧なのかもしれない。",
        "Kecurigaan bahwa banyak pilihan yang kita yakini telah "
        "dipilih dengan kehendak sendiri, sebenarnya sangat "
        "ditentukan oleh lingkungan atau kebetulan, tidak bisa "
        "sepenuhnya dihilangkan. Garis batas antara kehendak bebas "
        "dan takdir mungkin jauh lebih kabur daripada yang "
        "dipikirkan.",
        [
            ("どんな疑いを完全に払拭することはできませんか。", ["選択の多くが環境や偶然に規定されているのではないかという疑い", "自由意志は完全に存在するという疑い", "運命など存在しないという疑い", "誰も選択していないという疑い"], 0),
            ("何の境界線が思うよりもずっと曖昧なのかもしれませんか。", ["自由意志と運命", "過去と未来だけ", "現実と夢だけ", "善と悪だけ"], 0),
            ("この文章のテーマは何ですか。", ["自由意志と運命の関係", "経済政策の分析", "心理学の実験", "歴史学の方法論"], 0),
        ],
    ),
    (
        "kuukyo_bigaku_hihyou",
        "Kritik tentang Estetika Kekosongan",
        "何も置かれていない空間には、物で満たされた空間にはない独特"
        "の緊張感と静けさが宿る。あえて何も足さないという選択その"
        "ものが、最も雄弁な表現になり得るという逆説を、深く考えさせ"
        "られる。",
        "Ruang yang tidak diletakkan apa-apa memiliki ketegangan dan "
        "keheningan unik yang tidak dimiliki ruang yang dipenuhi "
        "barang. Dibuat berpikir dalam tentang paradoks bahwa "
        "pilihan untuk sengaja tidak menambahkan apa pun itu sendiri "
        "bisa menjadi ekspresi paling fasih.",
        [
            ("何も置かれていない空間には何が宿りますか。", ["独特の緊張感と静けさ", "何もない退屈さだけ", "恐怖だけ", "混乱だけ"], 0),
            ("何が最も雄弁な表現になり得るという逆説がありますか。", ["あえて何も足さないという選択", "たくさん物を置くこと", "色を多用すること", "装飾を増やすこと"], 0),
            ("この文章のテーマは何ですか。", ["空虚さの美学", "豪華さの重要性", "経済的な価値", "建築の技術"], 0),
        ],
    ),
    (
        "jibun_kikyou_reflection",
        "Refleksi tentang Arti Pulang ke Diri Sendiri",
        "長らく他者の期待に応え続けてきた人生の果てに、ふと自分自身"
        "が何を望んでいるのか分からなくなることがある。真の帰郷とは、"
        "地理的な場所へ戻ることではなく、忘れかけていた自己へと立ち"
        "返ることなのかもしれない。",
        "Setelah lama terus memenuhi ekspektasi orang lain, terkadang "
        "tiba-tiba menjadi tidak tahu apa yang sebenarnya diinginkan "
        "diri sendiri. Kepulangan sejati mungkin bukan kembali ke "
        "tempat geografis, melainkan kembali kepada diri sendiri "
        "yang hampir terlupakan.",
        [
            ("長らく他者の期待に応え続けた人生の果てに何が分からなくなることがありますか。", ["自分自身が何を望んでいるのか", "どこに住むべきか", "誰と結婚すべきか", "何を食べるべきか"], 0),
            ("真の帰郷とは何かもしれませんか。", ["忘れかけていた自己へと立ち返ること", "地理的な場所へ戻ること", "仕事を辞めること", "家族に会うことだけ"], 0),
            ("この文章のテーマは何ですか。", ["自己への回帰", "地理学の知識", "家族関係の修復方法", "旅行の計画"], 0),
        ],
    ),
    (
        "kyouiku_shinpo_hiniku_n1_4",
        "Esai tentang Ironi Kemajuan Pendidikan",
        "教育機会が拡大し、識字率も向上してきたはずであるにもかかわ"
        "らず、深く考える力そのものは必ずしも育っていないのではない"
        "かという懸念がある。知識の量と、思考の深さは、同じ速度で"
        "伸びるとは限らないのだろう。",
        "Meskipun kesempatan pendidikan seharusnya meluas dan tingkat "
        "melek huruf pun meningkat, ada kekhawatiran bahwa kemampuan "
        "berpikir mendalam itu sendiri belum tentu berkembang. "
        "Jumlah pengetahuan dan kedalaman pemikiran mungkin tidak "
        "selalu berkembang dengan kecepatan yang sama.",
        [
            ("教育機会や識字率はどうだったはずですか。", ["拡大し向上してきたはず", "縮小し悪化してきたはず", "全く変わらなかったはず", "誰も気にしなかったはず"], 0),
            ("何が必ずしも育っていないのではないかという懸念がありますか。", ["深く考える力そのもの", "識字率だけ", "学校の数だけ", "教師の数だけ"], 0),
            ("筆者は何が同じ速度で伸びるとは限らないと述べていますか。", ["知識の量と思考の深さ", "お金と時間だけ", "過去と未来だけ", "国内と海外だけ"], 0),
        ],
    ),
    (
        "yuuki_mubou_kyoukai_discussion",
        "Diskusi tentang Batas Antara Keberanian dan Kecerobohan",
        "危険を顧みず行動することは、時に勇気として称賛され、時に"
        "無謀として非難される。両者を分かつ境界線は、結果論によって"
        "事後的に引かれることが多く、行動の瞬間には本人にも判断が"
        "つかないのではないだろうか。",
        "Bertindak tanpa memperhatikan bahaya, terkadang dipuji "
        "sebagai keberanian, terkadang dikritik sebagai kecerobohan. "
        "Garis batas yang memisahkan keduanya seringkali ditarik "
        "secara retrospektif berdasarkan hasil, bukankah pada saat "
        "bertindak, orang yang bersangkutan pun tidak bisa "
        "menilainya?",
        [
            ("危険を顧みず行動することは何として称賛されることがありますか。", ["勇気", "無謀だけ", "愚かさだけ", "失敗だけ"], 0),
            ("両者を分かつ境界線はどう引かれることが多いですか。", ["結果論によって事後的に", "科学的に事前に", "誰にでも明確に", "法律によって"], 0),
            ("この文章のテーマは何ですか。", ["勇気と無謀の境界", "経済的なリスク管理", "スポーツの技術", "法律の解釈"], 0),
        ],
    ),
    (
        "senkusha_isan_seijaku_reflection",
        "Refleksi tentang Warisan Senyap Para Pendahulu",
        "今、当たり前のように享受している自由や権利の多くは、名も"
        "残さず声を上げ続けた先人たちの、静かな闘いの積み重ねの上に"
        "成り立っている。その事実を忘れずにいることこそ、最低限の"
        "敬意の表し方なのだろう。",
        "Banyak kebebasan dan hak yang sekarang dinikmati begitu "
        "saja sebagai hal wajar, sesungguhnya berdiri di atas "
        "akumulasi perjuangan diam-diam para pendahulu yang terus "
        "menyuarakan tanpa meninggalkan nama. Tidak melupakan fakta "
        "itu mungkin adalah bentuk penghormatan minimal.",
        [
            ("今、当たり前のように享受している自由や権利の多くは何の上に成り立っていますか。", ["名も残さず声を上げ続けた先人たちの静かな闘いの積み重ね", "偶然の産物", "政府の恩恵だけ", "経済成長だけ"], 0),
            ("何が最低限の敬意の表し方かもしれませんか。", ["その事実を忘れずにいること", "何もしないこと", "過去を無視すること", "感謝しないこと"], 0),
            ("この文章のテーマは何ですか。", ["先人への感謝と記憶", "経済史の分析", "法律の変遷", "政治制度の説明"], 0),
        ],
    ),
    (
        "hanpuku_shippai_taeru_tsuyosa_essay",
        "Esai tentang Ketahanan dalam Menghadapi Kegagalan Berulang",
        "一度の失敗に立ち直ることと、繰り返し失敗し続けてもなお挑戦"
        "し続けることとの間には、質的に異なる強さが存在するように"
        "思う。後者に宿る忍耐は、一度きりの成功譚では決して測ること"
        "のできないものなのだろう。",
        "Saya merasa ada kekuatan yang secara kualitatif berbeda "
        "antara bangkit dari satu kegagalan, dan terus mencoba "
        "meskipun gagal berulang kali. Kesabaran yang bersemayam "
        "dalam yang terakhir mungkin sesuatu yang sama sekali tidak "
        "bisa diukur dengan kisah sukses sekali jadi.",
        [
            ("何と何の間に質的に異なる強さが存在するように思われますか。", ["一度の失敗に立ち直ることと繰り返し失敗し続けても挑戦し続けること", "成功と失敗だけ", "勇気と臆病だけ", "才能と努力だけ"], 0),
            ("後者に宿る何は一度きりの成功譚では測れませんか。", ["忍耐", "才能", "運", "お金"], 0),
            ("この文章のテーマは何ですか。", ["繰り返す失敗への耐性", "成功の秘訣", "才能の重要性", "運の役割"], 0),
        ],
    ),
    (
        "tensai_shinwa_kojin_hihyou",
        "Kritik tentang Mitos Kejeniusan Tunggal",
        "歴史に名を残す偉業の多くは、一人の天才の孤独な閃きによって"
        "成し遂げられたと語られがちだが、実際にはその背後に無数の"
        "協力者や、時代の積み重ねが存在していることがほとんどだ。"
        "単独の英雄譚は、往々にして単純化された物語にすぎない。",
        "Banyak prestasi besar yang tercatat dalam sejarah cenderung "
        "diceritakan sebagai pencapaian melalui kilasan kesepian "
        "dari satu jenius, tetapi kenyataannya di baliknya hampir "
        "selalu ada banyak sekali kolaborator dan akumulasi zaman. "
        "Kisah kepahlawanan tunggal seringkali hanyalah narasi yang "
        "disederhanakan.",
        [
            ("歴史に名を残す偉業の多くはどう語られがちですか。", ["一人の天才の孤独な閃きによって成し遂げられた", "多くの人々の努力によって成し遂げられた", "偶然によって成し遂げられた", "誰も成し遂げなかった"], 0),
            ("実際にはその背後に何が存在していることがほとんどですか。", ["無数の協力者や時代の積み重ね", "一人の力だけ", "運だけ", "お金だけ"], 0),
            ("単独の英雄譚は往々にして何にすぎませんか。", ["単純化された物語", "完全な真実", "科学的な事実", "誰も信じない話"], 0),
        ],
    ),
]
